...
**Emarzona** est une plateforme SaaS e-commerce moderne et complète permettant aux entrepreneurs et entreprises de vendre **5 types de produits différents** :
...
- [x] Gestion multi-produits (Digital, Physical, Services, Courses, œuvres d'artistes)
...
- 📝 Issues: [GitHub Issues](https://github.com/emarzona/emarzona/issues)

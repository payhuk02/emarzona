-- Recover MF paid-but-stuck transaction (verified via paiementNotif statut=paid)
-- tx 99dfe92c-abbd-4676-ac78-36ead1eddfdc / order 6bda23ac-0809-4600-b6d7-fc0e582c776a

SELECT public.process_payment_webhook_atomic(
  p_provider := 'moneyfusion',
  p_external_event_id := 'manual-recover:6a6102a6a26ff341bb014b72:20260723',
...
-- Refresh earnings for the store on the order
...
SELECT jsonb_build_object(
  ...
  'payments', (SELECT count(*) FROM payments p WHERE p.order_id = o.id AND p.status = 'completed'),
  'earnings', (
    SELECT jsonb_build_object(

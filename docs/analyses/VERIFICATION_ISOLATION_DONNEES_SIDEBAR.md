...
**Hooks** : 11. ✅ `src/hooks/useDashboardStats.ts` 12. ✅ `src/hooks/useAdvancedDashboardStats.ts`

**Composants** : 13. ✅ `src/components/storefront/StoreHeader.tsx` 14. ✅ `src/components/physical/promotions/PromotionsManager.tsx` 15. ✅ `src/components/physical/inventory/StockAlerts.tsx` 16. ✅ `src/components/physical/inventory/WarehouseManager.tsx`

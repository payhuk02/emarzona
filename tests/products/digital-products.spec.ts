...
test.describe('Digital Products', () => {
  ...
  test('should create digital product with all steps', async ({ page }) => {
    ...
    await page.fill(
      ...
      'This is a test digital product created via E2E tests'
    );
    ...
    // Step 4: SEO
    await page.fill(
      'input[name="metaTitle"], input[placeholder*="SEO"]',
      'Test Digital Product SEO'
    );
  ...
  test('should display digital products in list', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="product-card"], .product-card')).toHaveCount({
      timeout: 5000,
    });
  });

...
DROP TRIGGER IF EXISTS trigger_set_warranty_end_date ON public.product_warranties;
...
DROP TRIGGER IF EXISTS trigger_create_warranty_history ON public.product_warranties;

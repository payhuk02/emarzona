...
DROP POLICY IF EXISTS "Store owners can view own AB tests" ON public.email_ab_tests;
...
DROP POLICY IF EXISTS "Admins can view all AB tests" ON public.email_ab_tests;

...
DROP POLICY IF EXISTS "Anyone can view media" ON public.review_media;
...
DROP POLICY IF EXISTS "Users can add media to own reviews" ON public.review_media;
...
DROP POLICY IF EXISTS "Anyone can view review stats" ON public.product_review_stats;

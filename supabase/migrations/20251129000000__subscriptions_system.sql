...
DROP POLICY IF EXISTS "Store owners can view store subscriptions" ON public.subscriptions;
...
DROP POLICY IF EXISTS "Store owners can create subscriptions" ON public.subscriptions;
...
DROP POLICY IF EXISTS "Store owners can view subscription payments" ON public.subscription_payments;
...
DROP POLICY IF EXISTS "Store owners can manage plans" ON public.subscription_plans;

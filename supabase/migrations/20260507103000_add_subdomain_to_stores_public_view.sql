-- Ensure storefront resolution by subdomain works consistently.
-- Some storefront flows query stores_public by `subdomain`.
CREATE OR REPLACE VIEW public.stores_public AS
  SELECT
    id, name, slug, subdomain, description, logo_url, banner_url, is_active,

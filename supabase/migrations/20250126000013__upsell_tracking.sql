...
DROP POLICY IF EXISTS "Users can view their own upsell tracking" ON public.upsell_tracking;
...
DROP POLICY IF EXISTS "Store owners can view upsell tracking for their products" ON public.upsell_tracking;
...
DROP POLICY IF EXISTS "Public can insert upsell tracking" ON public.upsell_tracking;

...
-- Trigger updated_at
DROP TRIGGER IF EXISTS update_enrollment_failures_updated_at ON public.course_enrollment_failures;
...
DROP POLICY IF EXISTS "Store owners can view enrollment failures" ON public.course_enrollment_failures;

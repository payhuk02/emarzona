...
DROP POLICY IF EXISTS "Members can create reactions" ON public.community_reactions;
...
DROP POLICY IF EXISTS "Members can delete their own reactions" ON public.community_reactions;
...
DROP POLICY IF EXISTS "Members can create follows" ON public.community_follows;
...
DROP POLICY IF EXISTS "Members can delete their own follows" ON public.community_follows;
...
DROP POLICY IF EXISTS "Members can view their own notifications" ON public.community_notifications;
...
DROP POLICY IF EXISTS "Members can update their own notifications" ON public.community_notifications;
...
DROP TRIGGER IF EXISTS update_post_likes_count ON public.community_reactions;

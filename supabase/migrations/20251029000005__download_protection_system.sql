...
DROP POLICY IF EXISTS "Vendors view tokens" ON public.download_tokens;
...
DROP POLICY IF EXISTS "Customers view own tokens" ON public.download_tokens;
...
DROP POLICY IF EXISTS "Vendors view logs" ON public.download_logs;

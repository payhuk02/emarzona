...
DROP TRIGGER IF EXISTS update_digital_product_versions_updated_at ON public.digital_product_versions;
...
DROP TRIGGER IF EXISTS notify_users_new_version_trigger ON public.digital_product_versions;
...
DROP POLICY IF EXISTS "digital_product_versions_select_public" ON public.digital_product_versions;
...
DROP POLICY IF EXISTS "digital_product_versions_manage_owners" ON public.digital_product_versions;
...
DROP POLICY IF EXISTS "update_notifications_select_own" ON public.digital_product_update_notifications;
...
DROP POLICY IF EXISTS "update_notifications_update_own" ON public.digital_product_update_notifications;
...
DROP POLICY IF EXISTS "version_downloads_select_own" ON public.digital_product_version_downloads;

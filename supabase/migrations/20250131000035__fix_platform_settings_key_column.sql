...
BEGIN
  ...
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Allow select to authenticated" ON public.platform_settings;
CREATE POLICY "Allow select to authenticated" 
  ...
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Allow update to admins" ON public.platform_settings;
CREATE POLICY "Allow update to admins" 
  ...
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Allow insert to admins" ON public.platform_settings;

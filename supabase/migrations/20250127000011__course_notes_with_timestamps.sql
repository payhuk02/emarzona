...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_course_notes_enrollment_id ON public.course_notes(enrollment_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_course_notes_lesson_id ON public.course_notes(lesson_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_course_notes_timestamp ON public.course_notes(lesson_id, timestamp_seconds);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE TABLE IF NOT EXISTS public.course_note_bookmarks (
      id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
      enrollment_id UUID NOT NULL REFERENCES public.course_enrollments(id) ON DELETE CASCADE,
      lesson_id UUID NOT NULL REFERENCES public.course_lessons(id) ON DELETE CASCADE,
      course_id UUID NOT NULL REFERENCES public.courses(id) ON DELETE CASCADE,
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_note_bookmarks_enrollment_id ON public.course_note_bookmarks(enrollment_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_note_bookmarks_lesson_id ON public.course_note_bookmarks(lesson_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Students can view own notes" ON public.course_notes;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Students can create own notes" ON public.course_notes;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Students can update own notes" ON public.course_notes;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Students can delete own notes" ON public.course_notes;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Students can manage own bookmarks" ON public.course_note_bookmarks;

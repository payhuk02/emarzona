...
DROP POLICY IF EXISTS "product_returns_select_policy" ON product_returns;
...
DROP POLICY IF EXISTS "product_returns_insert_policy" ON product_returns;
...
-- UPDATE : Propriétaires ou admins
DROP POLICY IF EXISTS "product_returns_update_policy" ON product_returns;
...
-- DELETE : Seulement admins
DROP POLICY IF EXISTS "product_returns_delete_policy" ON product_returns;
...
DROP POLICY IF EXISTS "service_bookings_select_policy" ON service_bookings;
...
DROP POLICY IF EXISTS "service_bookings_insert_policy" ON service_bookings;
CREATE POLICY "service_bookings_insert_policy"
  ON service_bookings FOR INSERT
  WITH CHECK (user_id = auth.uid());

-- UPDATE : Clients, propriétaires ou admins
DROP POLICY IF EXISTS "service_bookings_update_policy" ON service_bookings;
...
DROP POLICY IF EXISTS "service_bookings_delete_policy" ON service_bookings;

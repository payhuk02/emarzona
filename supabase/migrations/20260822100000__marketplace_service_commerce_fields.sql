-- Expose service commerce fields on marketplace listing (Fiverr-style "À partir de").
-- pricing_type / fulfillment_mode / duration / staff / min delivery-tier package price.
...
COMMENT ON VIEW public.marketplace_products_optimized IS
  'Vue marketplace ; WhatsApp produit ; champs commerce service (formules / RDV)';

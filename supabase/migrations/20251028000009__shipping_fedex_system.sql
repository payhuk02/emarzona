...
DROP TRIGGER IF EXISTS update_shipping_carriers_timestamp ON public.shipping_carriers;
...
DROP TRIGGER IF EXISTS update_shipping_labels_timestamp ON public.shipping_labels;
CREATE TRIGGER update_shipping_labels_timestamp
  BEFORE UPDATE ON public.shipping_labels
  FOR EACH ROW EXECUTE FUNCTION update_shipping_updated_at();

DROP TRIGGER IF EXISTS update_pickup_requests_timestamp ON public.shipping_pickup_requests;
...
DROP POLICY IF EXISTS "Anyone can view active carriers" ON public.shipping_carriers;
...
DROP POLICY IF EXISTS "Store owners can view their shipments" ON public.shipments;
...
DROP POLICY IF EXISTS "Store owners can create shipments" ON public.shipments;
...
DROP POLICY IF EXISTS "Store owners can update their shipments" ON public.shipments;
...
DROP POLICY IF EXISTS "Store owners can view their labels" ON public.shipping_labels;
...
DROP POLICY IF EXISTS "Store owners can manage pickup requests" ON public.shipping_pickup_requests;

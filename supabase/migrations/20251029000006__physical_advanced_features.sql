...
-- Pre-orders policies
DROP POLICY IF EXISTS "Users can view pre-orders from their stores" ON public.pre_orders;
...
DROP POLICY IF EXISTS "Users can manage pre-orders in their stores" ON public.pre_orders;
...
DROP POLICY IF EXISTS "Users can view pre-order customers" ON public.pre_order_customers;
...
-- Backorders policies
DROP POLICY IF EXISTS "Users can view backorders from their stores" ON public.backorders;
...
DROP POLICY IF EXISTS "Users can manage backorders in their stores" ON public.backorders;
...
DROP POLICY IF EXISTS "Users can view stock alerts from their stores" ON public.stock_alerts;
...
DROP POLICY IF EXISTS "Users can manage stock alerts in their stores" ON public.stock_alerts;
...
DROP POLICY IF EXISTS "Users can view size charts from their stores" ON public.size_charts;
...
DROP POLICY IF EXISTS "Users can manage size charts in their stores" ON public.size_charts;
...
DROP POLICY IF EXISTS "Users can view size chart measurements" ON public.size_chart_measurements;
...
DROP POLICY IF EXISTS "Users can manage size chart measurements" ON public.size_chart_measurements;
...
DROP POLICY IF EXISTS "Users can view bundles from their stores" ON public.product_bundles;
...
DROP POLICY IF EXISTS "Users can manage bundles in their stores" ON public.product_bundles;
...
DROP POLICY IF EXISTS "Users can manage bundle items" ON public.bundle_items;
...
DROP POLICY IF EXISTS "Users can view variant images" ON public.variant_images;
CREATE POLICY "Users can view variant images"
  ON public.variant_images FOR SELECT
  USING (true); -- Public read

DROP POLICY IF EXISTS "Users can manage variant images for their products" ON public.variant_images;
...
DROP TRIGGER IF EXISTS update_backorders_updated_at ON public.backorders;
...
DROP TRIGGER IF EXISTS update_size_charts_updated_at ON public.size_charts;
CREATE TRIGGER update_size_charts_updated_at
    BEFORE UPDATE ON public.size_charts
    FOR EACH ROW
    EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_product_bundles_updated_at ON public.product_bundles;

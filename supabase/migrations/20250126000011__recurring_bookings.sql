...
DROP TRIGGER IF EXISTS update_recurring_patterns_updated_at ON public.recurring_booking_patterns;
...
DROP POLICY IF EXISTS "Users can view own recurring patterns" ON public.recurring_booking_patterns;
...
DROP POLICY IF EXISTS "Users can create own recurring patterns" ON public.recurring_booking_patterns;
...
DROP POLICY IF EXISTS "Users can update own recurring patterns" ON public.recurring_booking_patterns;
...
DROP POLICY IF EXISTS "Providers can view patterns for their services" ON public.recurring_booking_patterns;

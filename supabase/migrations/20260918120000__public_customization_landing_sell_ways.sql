-- Expose media.images.landingSellWays on the public customization RPC
-- (admin Media section saves it; anonymous landing was always falling back to bundled assets)

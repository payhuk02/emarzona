...
DROP POLICY IF EXISTS "Store owners can manage artist products" ON public.artist_products;
...
DROP POLICY IF EXISTS "Auctions viewable by everyone" ON public.artist_product_auctions;
CREATE POLICY "Auctions viewable by everyone" ON public.artist_product_auctions FOR SELECT USING (true);
DROP POLICY IF EXISTS "Store owners can manage auctions" ON public.artist_product_auctions;
...
DROP POLICY IF EXISTS "Bids viewable on active auctions" ON public.auction_bids;
CREATE POLICY "Bids viewable on active auctions" ON public.auction_bids FOR SELECT USING (true);
DROP POLICY IF EXISTS "Authenticated users can bid" ON public.auction_bids;
CREATE POLICY "Authenticated users can bid" ON public.auction_bids FOR INSERT WITH CHECK (auth.uid() = bidder_id);
DROP POLICY IF EXISTS "Users can view own bids" ON public.auction_bids;
...
DROP POLICY IF EXISTS "Users can manage own watchlist" ON public.auction_watchlist;
...
DROP POLICY IF EXISTS "Public portfolios viewable" ON public.artist_portfolios;
CREATE POLICY "Public portfolios viewable" ON public.artist_portfolios FOR SELECT USING (is_public = true);
DROP POLICY IF EXISTS "Store owners can manage portfolios" ON public.artist_portfolios;
...
DROP POLICY IF EXISTS "Public galleries viewable" ON public.artist_galleries;
CREATE POLICY "Public galleries viewable" ON public.artist_galleries FOR SELECT USING (is_public = true);
DROP POLICY IF EXISTS "Store owners can manage galleries" ON public.artist_galleries;
...
DROP POLICY IF EXISTS "Gallery artworks viewable" ON public.gallery_artworks;
CREATE POLICY "Gallery artworks viewable" ON public.gallery_artworks FOR SELECT USING (true);
DROP POLICY IF EXISTS "Store owners can manage gallery artworks" ON public.gallery_artworks;
...
DROP POLICY IF EXISTS "Public collections viewable" ON public.artist_collections;
CREATE POLICY "Public collections viewable" ON public.artist_collections FOR SELECT USING (is_public = true);
DROP POLICY IF EXISTS "Store owners can manage collections" ON public.artist_collections;
...
DROP POLICY IF EXISTS "Collection items viewable" ON public.artist_collection_items;
CREATE POLICY "Collection items viewable" ON public.artist_collection_items FOR SELECT USING (true);
DROP POLICY IF EXISTS "Store owners can manage collection items" ON public.artist_collection_items;
...
DROP POLICY IF EXISTS "Store owners can manage dedications" ON public.artist_product_dedications;
...
DROP POLICY IF EXISTS "Templates viewable" ON public.dedication_templates;
CREATE POLICY "Templates viewable" ON public.dedication_templates FOR SELECT USING (is_active = true);
DROP POLICY IF EXISTS "Store owners can manage templates" ON public.dedication_templates;
...
DROP POLICY IF EXISTS "Provenance viewable by everyone" ON public.artwork_provenance;
CREATE POLICY "Provenance viewable by everyone" ON public.artwork_provenance FOR SELECT USING (true);
DROP POLICY IF EXISTS "Store owners can manage provenance" ON public.artwork_provenance;
...
DROP POLICY IF EXISTS "Artwork certificates viewable" ON public.artwork_certificates;
CREATE POLICY "Artwork certificates viewable" ON public.artwork_certificates FOR SELECT USING (true);
DROP POLICY IF EXISTS "Store owners can manage artwork certificates" ON public.artwork_certificates;
...
DROP POLICY IF EXISTS "3D models viewable by everyone" ON public.artwork_3d_models;
CREATE POLICY "3D models viewable by everyone" ON public.artwork_3d_models FOR SELECT USING (true);
DROP POLICY IF EXISTS "Store owners can manage 3d models" ON public.artwork_3d_models;
...
DROP POLICY IF EXISTS "Certificates publicly verifiable" ON public.artist_product_certificates;
CREATE POLICY "Certificates publicly verifiable" ON public.artist_product_certificates FOR SELECT USING (is_public = true);
DROP POLICY IF EXISTS "Users can view own certificates" ON public.artist_product_certificates;
CREATE POLICY "Users can view own certificates" ON public.artist_product_certificates FOR SELECT USING (auth.uid() = user_id);
DROP POLICY IF EXISTS "Store owners can manage certificates" ON public.artist_product_certificates;
...
DROP TRIGGER IF EXISTS update_artist_products_updated_at ON public.artist_products;
...
DROP TRIGGER IF EXISTS update_artist_product_auctions_updated_at ON public.artist_product_auctions;
...
DROP TRIGGER IF EXISTS update_artist_portfolios_updated_at ON public.artist_portfolios;
...
DROP TRIGGER IF EXISTS update_artist_galleries_updated_at ON public.artist_galleries;
...
DROP TRIGGER IF EXISTS update_artist_collections_updated_at ON public.artist_collections;
...
DROP TRIGGER IF EXISTS update_artist_product_dedications_updated_at ON public.artist_product_dedications;
...
DROP TRIGGER IF EXISTS update_dedication_templates_updated_at ON public.dedication_templates;
...
DROP TRIGGER IF EXISTS update_artwork_provenance_updated_at ON public.artwork_provenance;
...
DROP TRIGGER IF EXISTS update_artwork_certificates_updated_at ON public.artwork_certificates;
...
DROP TRIGGER IF EXISTS update_artwork_3d_models_updated_at ON public.artwork_3d_models;
...
DROP TRIGGER IF EXISTS update_artist_product_certificates_updated_at ON public.artist_product_certificates;

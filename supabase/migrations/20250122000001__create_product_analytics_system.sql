...
DROP POLICY IF EXISTS "Users can view analytics for their own products" ON public.product_analytics;
...
DROP POLICY IF EXISTS "Users can update analytics for their own products" ON public.product_analytics;
...
DROP POLICY IF EXISTS "System can insert analytics for products" ON public.product_analytics;
...
DROP POLICY IF EXISTS "Users can manage their own reports" ON public.analytics_reports;
...
DROP TRIGGER IF EXISTS trigger_update_product_analytics ON public.analytics_events;

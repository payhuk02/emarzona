-- Fix dashboard_recent_orders materialized view GROUP BY issue
-- Date: 22 January 2026
-- Fix for: column "dashboard_recent_orders.created_at" must appear in the GROUP BY clause
...
DO $$
BEGIN
  RAISE NOTICE 'dashboard_recent_orders materialized view fixed and refreshed successfully!';
  RAISE NOTICE 'GROUP BY clause now includes all necessary columns including created_at';
END $$;
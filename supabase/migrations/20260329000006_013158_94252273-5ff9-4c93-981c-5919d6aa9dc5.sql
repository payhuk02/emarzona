...
DROP POLICY IF EXISTS "Store owners can manage services" ON public.services;
...
-- Policies: bookings
DROP POLICY IF EXISTS "Store owners can manage bookings" ON public.bookings;
...
-- Policies: promotions
DROP POLICY IF EXISTS "Active promotions viewable" ON public.promotions;
CREATE POLICY "Active promotions viewable" ON public.promotions FOR SELECT USING (is_active = true);
DROP POLICY IF EXISTS "Store owners can manage promotions" ON public.promotions;
...
-- Policies: invoices
DROP POLICY IF EXISTS "Store owners can manage invoices" ON public.invoices;
...
DROP POLICY IF EXISTS "Store owners can manage abandoned carts" ON public.abandoned_carts;
...
DROP POLICY IF EXISTS "Users can view own carts" ON public.abandoned_carts;
CREATE POLICY "Users can view own carts" ON public.abandoned_carts FOR SELECT USING (auth.uid() = user_id);

-- Policies: product_views
DROP POLICY IF EXISTS "Product views viewable by store owners" ON public.product_views;

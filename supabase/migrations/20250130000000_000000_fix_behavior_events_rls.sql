...
DROP POLICY IF EXISTS "Users can manage their own behavior events" ON user_behavior_events;
...
DROP POLICY IF EXISTS "Service role can manage all behavior events" ON user_behavior_events;

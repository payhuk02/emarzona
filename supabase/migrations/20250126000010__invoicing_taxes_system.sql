...
DROP POLICY IF EXISTS "Store owners can create invoices" ON public.invoices;
...
DROP POLICY IF EXISTS "Store owners can update their invoices" ON public.invoices;
...
DROP POLICY IF EXISTS "Public can view active tax configurations" ON public.tax_configurations;
CREATE POLICY "Public can view active tax configurations"
ON public.tax_configurations FOR SELECT
USING (is_active = true);

DROP POLICY IF EXISTS "Store owners can manage their tax configurations" ON public.tax_configurations;

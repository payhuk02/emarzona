...
DO $$ BEGIN
  IF EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_shipping_carriers_store_id ON public.shipping_carriers(store_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS update_shipping_carriers_updated_at ON public.shipping_carriers;
...
DO $$ BEGIN
  IF EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_shipping_labels_store_id ON public.shipping_labels(store_id);
  END IF;
END $$;
...
DO $$ BEGIN
  ...
  IF EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_shipping_labels_carrier_id ON public.shipping_labels(carrier_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_tracking_events_label_id ON public.shipping_tracking_events(shipping_label_id);
  END IF;
END $$;
...
DO $$ BEGIN
  ...
  IF EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_tracking_events_tracking_number ON public.shipping_tracking_events(tracking_number);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE TABLE IF NOT EXISTS public.shipping_rate_requests (
      id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
      store_id UUID NOT NULL REFERENCES public.stores(id) ON DELETE CASCADE,
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_rate_requests_store_id ON public.shipping_rate_requests(store_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_rate_requests_cache ON public.shipping_rate_requests(cache_expires_at) 
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Store owners can manage carriers" ON public.shipping_carriers;
...
DO $$ BEGIN
  IF EXISTS (
    ...
    DROP POLICY IF EXISTS "Store owners can manage labels" ON public.shipping_labels;
...
DO $$ BEGIN
  IF EXISTS (
    ...
    DROP POLICY IF EXISTS "Customers can view own labels" ON public.shipping_labels;
...
DO $$ BEGIN
  IF EXISTS (
    ...
    DROP POLICY IF EXISTS "Store owners can view requests" ON public.shipping_rate_requests;

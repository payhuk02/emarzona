...
DROP TRIGGER IF EXISTS update_lesson_progress_updated_at ON public.course_lesson_progress;
...
DROP TRIGGER IF EXISTS update_discussions_updated_at ON public.course_discussions;
...
DROP TRIGGER IF EXISTS update_replies_updated_at ON public.course_discussion_replies;

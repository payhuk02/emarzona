...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE TABLE IF NOT EXISTS public.batch_shipments (
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_batch_shipments_store_id ON public.batch_shipments(store_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_batch_shipments_status ON public.batch_shipments(status);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_batch_shipments_batch_number ON public.batch_shipments(batch_number);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS update_batch_shipments_updated_at ON public.batch_shipments;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE TABLE IF NOT EXISTS public.batch_shipment_orders (
      id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_batch_shipment_orders_batch_id ON public.batch_shipment_orders(batch_shipment_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_batch_shipment_orders_order_id ON public.batch_shipment_orders(order_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_batch_shipment_orders_status ON public.batch_shipment_orders(status);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS update_batch_shipment_orders_updated_at ON public.batch_shipment_orders;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE TABLE IF NOT EXISTS public.batch_label_templates (
      id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
      store_id UUID NOT NULL REFERENCES public.stores(id) ON DELETE CASCADE,
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_batch_label_templates_store_id ON public.batch_label_templates(store_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS update_batch_label_templates_updated_at ON public.batch_label_templates;
...
DO $$ BEGIN
  IF EXISTS (
    ...
    DROP FUNCTION IF EXISTS public.generate_batch_shipment_number();
  END IF;
END $$;
...
DO $$ BEGIN
  IF EXISTS (
    ...
    DROP FUNCTION IF EXISTS public.update_batch_shipment_status(UUID);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Store owners can manage batches" ON public.batch_shipments;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Store owners can view batch orders" ON public.batch_shipment_orders;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Store owners can manage templates" ON public.batch_label_templates;

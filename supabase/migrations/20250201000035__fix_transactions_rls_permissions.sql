...
DROP POLICY IF EXISTS "Store owners can view their store transactions" ON public.transactions;
...
DROP POLICY IF EXISTS "Store owners can update their store transactions" ON public.transactions;

-- Renforce l'autorisation sur les RPC jalons (post-déploiement P3)
...
-- activate / complete : réservés au fulfillment edge (service_role)
REVOKE EXECUTE ON FUNCTION public.activate_service_order_checkout_milestones(UUID) FROM authenticated;
REVOKE EXECUTE ON FUNCTION public.complete_service_milestone_balance_payment(UUID) FROM authenticated;

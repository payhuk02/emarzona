...
DROP TRIGGER IF EXISTS update_comment_edited_at_trigger ON public.portfolio_comments;
...
DROP TRIGGER IF EXISTS update_comment_likes_count_trigger ON public.portfolio_comment_likes;
...
DROP TRIGGER IF EXISTS update_comment_replies_count_trigger ON public.portfolio_comments;
...
DROP TRIGGER IF EXISTS update_comment_reported_count_trigger ON public.portfolio_comment_reports;

...
-- Les admins peuvent tout faire
DROP POLICY IF EXISTS "Admins can manage all segments" ON public.email_segments;
...
DROP POLICY IF EXISTS "Users can view own enrollments" ON public.email_sequence_enrollments;
...
DROP POLICY IF EXISTS "Users can view own tags" ON public.email_user_tags;

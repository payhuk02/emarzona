-- Persist products.category (slug) for artist create/update RPCs.
-- Marketplace artist filters match on products.category; previously only category_id was written.
...
BEGIN
  ...
  INSERT INTO public.products (
    ...
    product_type, category, category_id, image_url, images, tags,

...
DROP POLICY IF EXISTS "Admins can manage commissions" ON public.platform_commissions;
...
DROP POLICY IF EXISTS "Store owners can view their commissions" ON public.platform_commissions;
...
CREATE INDEX IF NOT EXISTS idx_platform_commissions_payment_id ON public.platform_commissions(payment_id);
CREATE INDEX IF NOT EXISTS idx_platform_commissions_created_at ON public.platform_commissions(created_at);

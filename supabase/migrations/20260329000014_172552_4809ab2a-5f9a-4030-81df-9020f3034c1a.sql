...
DROP POLICY IF EXISTS "Sequence steps inherit sequence access" ON public.email_sequence_steps;
...
DROP TRIGGER IF EXISTS update_email_ab_tests_updated_at ON public.email_ab_tests;
...
DROP POLICY IF EXISTS "Community members viewable" ON public.community_members;
CREATE POLICY "Community members viewable" ON public.community_members FOR SELECT USING (status = 'approved');
DROP POLICY IF EXISTS "Users manage own member profile" ON public.community_members;
CREATE POLICY "Users manage own member profile" ON public.community_members FOR ALL USING (auth.uid() = user_id);
DROP POLICY IF EXISTS "Admins manage community" ON public.community_members;
...
DROP POLICY IF EXISTS "Published posts viewable" ON public.community_posts;
...
DROP POLICY IF EXISTS "Admins manage all posts" ON public.community_posts;
...
DROP POLICY IF EXISTS "Published comments viewable" ON public.community_comments;
CREATE POLICY "Published comments viewable" ON public.community_comments FOR SELECT USING (status = 'published');
DROP POLICY IF EXISTS "Authors manage own comments" ON public.community_comments;
...
DROP POLICY IF EXISTS "Admins manage all comments" ON public.community_comments;
...
DROP POLICY IF EXISTS "Reactions viewable" ON public.community_reactions;

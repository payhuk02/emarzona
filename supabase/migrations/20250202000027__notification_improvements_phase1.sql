...
DROP POLICY IF EXISTS "Users can view own rate limits" ON public.notification_rate_limits;
...
DROP POLICY IF EXISTS "Users can view own retries" ON public.notification_retries;
...
DROP POLICY IF EXISTS "Users can view own dead letters" ON public.notification_dead_letters;

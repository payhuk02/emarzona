-- =============================================================================
-- Align create_public_{digital,course,artist}_order with prod fee logic (2%+100).
-- Physical already patched in 20260722023000. Source: apply-public-order-rpcs-prod.sql
-- Keeps greenfield / CI migrations in sync with linked prod RPCs.
-- =============================================================================
BEGIN;
...
BEGIN
  ...
  ELSE
    -- Autres devises : forfait ~100 XOF converti grossi̬rement via EUR
    v_fixed := ROUND((100.0 / 655.957)::NUMERIC, 2);
  END IF;

-- Sprint 3 follow-up: marketplace search/filter RPCs still read stores.logo_url (dropped).
-- Point store_logo_url at store_appearance so guest marketplace search works again.
...
COMMENT ON FUNCTION public.search_products IS
  'Full-text product search; store_logo_url from store_appearance (Sprint 3).';

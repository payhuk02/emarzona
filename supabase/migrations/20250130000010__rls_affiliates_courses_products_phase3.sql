...
DROP POLICY IF EXISTS "affiliates_insert_policy" ON affiliates;
...
DROP POLICY IF EXISTS "affiliates_update_policy" ON affiliates;
...
DROP POLICY IF EXISTS "affiliates_delete_policy" ON affiliates;
...
DROP POLICY IF EXISTS "affiliate_links_select_policy" ON affiliate_links;
...
DROP POLICY IF EXISTS "affiliate_links_insert_policy" ON affiliate_links;
...
DROP POLICY IF EXISTS "affiliate_links_update_policy" ON affiliate_links;
...
DROP POLICY IF EXISTS "affiliate_links_delete_policy" ON affiliate_links;
...
DROP POLICY IF EXISTS "commission_payments_select_policy" ON commission_payments;
...
DROP POLICY IF EXISTS "commission_payments_insert_policy" ON commission_payments;
...
DROP POLICY IF EXISTS "commission_payments_update_policy" ON commission_payments;
...
-- DELETE : Seulement admins
DROP POLICY IF EXISTS "commission_payments_delete_policy" ON commission_payments;
...
-- SELECT : Visibles si le produit parent est visible
DROP POLICY IF EXISTS "physical_products_select_policy" ON physical_products;
...
-- INSERT : Via produit parent (propriétaires ou admins)
DROP POLICY IF EXISTS "physical_products_insert_policy" ON physical_products;
...
-- UPDATE : Propriétaires de boutique ou admins
DROP POLICY IF EXISTS "physical_products_update_policy" ON physical_products;
...
-- DELETE : Seulement admins
DROP POLICY IF EXISTS "physical_products_delete_policy" ON physical_products;
...
-- SELECT : Visibles si le produit parent est visible
DROP POLICY IF EXISTS "service_products_select_policy" ON service_products;
...
-- INSERT : Via produit parent (propriétaires ou admins)
DROP POLICY IF EXISTS "service_products_insert_policy" ON service_products;
...
-- UPDATE : Propriétaires de boutique ou admins
DROP POLICY IF EXISTS "service_products_update_policy" ON service_products;
...
-- DELETE : Seulement admins
DROP POLICY IF EXISTS "service_products_delete_policy" ON service_products;
...
DROP POLICY IF EXISTS "store_withdrawals_select_policy" ON store_withdrawals;
...
DROP POLICY IF EXISTS "store_withdrawals_insert_policy" ON store_withdrawals;
...
DROP POLICY IF EXISTS "store_withdrawals_update_policy" ON store_withdrawals;
...
-- DELETE : Seulement admins
DROP POLICY IF EXISTS "store_withdrawals_delete_policy" ON store_withdrawals;

...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_warehouse_locations_parent ON public.warehouse_locations(parent_location_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_warehouse_inventory_variant_id ON public.warehouse_inventory(variant_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_warehouse_inventory_location_id ON public.warehouse_inventory(location_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_warehouse_transfers_store_id ON public.warehouse_transfers(store_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_warehouse_transfers_from_warehouse ON public.warehouse_transfers(from_warehouse_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_warehouse_transfers_to_warehouse ON public.warehouse_transfers(to_warehouse_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS update_warehouse_transfers_updated_at ON public.warehouse_transfers;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_transfer_items_transfer_id ON public.warehouse_transfer_items(transfer_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_transfer_items_product_id ON public.warehouse_transfer_items(product_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS update_transfer_items_updated_at ON public.warehouse_transfer_items;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_warehouse_allocations_warehouse_id ON public.warehouse_allocations(warehouse_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_warehouse_allocations_order_id ON public.warehouse_allocations(order_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_warehouse_allocations_status ON public.warehouse_allocations(status);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS update_warehouse_allocations_updated_at ON public.warehouse_allocations;
...
DO $$ BEGIN
  IF EXISTS (
    ...
    DROP FUNCTION IF EXISTS public.generate_warehouse_transfer_number();
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS trigger_update_warehouse_capacity ON public.warehouse_inventory;
...
DO $$ BEGIN
  IF EXISTS (
    ...
    DROP FUNCTION IF EXISTS public.adjust_warehouse_inventory(UUID, UUID, UUID, INTEGER, UUID);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Store owners can manage warehouses" ON public.warehouses;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Store owners can manage locations" ON public.warehouse_locations;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Store owners can manage inventory" ON public.warehouse_inventory;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Store owners can manage transfers" ON public.warehouse_transfers;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Store owners can manage allocations" ON public.warehouse_allocations;

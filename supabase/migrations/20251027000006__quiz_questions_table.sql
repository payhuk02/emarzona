...
DROP POLICY IF EXISTS "Instructors can manage their quiz questions" ON public.quiz_questions;
...
DROP POLICY IF EXISTS "Enrolled students can view questions" ON public.quiz_questions;

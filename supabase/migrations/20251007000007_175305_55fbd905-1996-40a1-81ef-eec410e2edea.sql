...
CREATE POLICY "Admins can delete profiles" ON public.profiles FOR DELETE USING (has_role(auth.uid(), ''admin''))';
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'stores' AND policyname = 'Admins can view all stores') THEN
    EXECUTE 'DROP POLICY IF EXISTS "Admins can view all stores" ON public.stores;
CREATE POLICY "Admins can view all stores" ON public.stores FOR SELECT USING (has_role(auth.uid(), ''admin''))';
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'stores' AND policyname = 'Admins can update all stores') THEN
    EXECUTE 'DROP POLICY IF EXISTS "Admins can update all stores" ON public.stores;
CREATE POLICY "Admins can update all stores" ON public.stores FOR UPDATE USING (has_role(auth.uid(), ''admin''))';
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'stores' AND policyname = 'Admins can delete any store') THEN
    EXECUTE 'DROP POLICY IF EXISTS "Admins can delete any store" ON public.stores;
CREATE POLICY "Admins can delete any store" ON public.stores FOR DELETE USING (has_role(auth.uid(), ''admin''))';
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'products' AND policyname = 'Admins can update all products') THEN
    EXECUTE 'DROP POLICY IF EXISTS "Admins can update all products" ON public.products;
CREATE POLICY "Admins can update all products" ON public.products FOR UPDATE USING (has_role(auth.uid(), ''admin''))';
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'products' AND policyname = 'Admins can delete any product') THEN
    EXECUTE 'DROP POLICY IF EXISTS "Admins can delete any product" ON public.products;
CREATE POLICY "Admins can delete any product" ON public.products FOR DELETE USING (has_role(auth.uid(), ''admin''))';
  END IF;
...
CREATE POLICY "Admins can view all orders" ON public.orders FOR SELECT USING (has_role(auth.uid(), ''admin''))';
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'orders' AND policyname = 'Admins can update all orders') THEN
    EXECUTE 'DROP POLICY IF EXISTS "Admins can update all orders" ON public.orders;
CREATE POLICY "Admins can update all orders" ON public.orders FOR UPDATE USING (has_role(auth.uid(), ''admin''))';
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'orders' AND policyname = 'Admins can delete any order') THEN
    EXECUTE 'DROP POLICY IF EXISTS "Admins can delete any order" ON public.orders;
CREATE POLICY "Admins can delete any order" ON public.orders FOR DELETE USING (has_role(auth.uid(), ''admin''))';
  END IF;
...
CREATE POLICY "Admins can update all payments" ON public.payments FOR UPDATE USING (has_role(auth.uid(), ''admin''))';
  END IF;
  
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'payments' AND policyname = 'Admins can delete any payment') THEN
    EXECUTE 'DROP POLICY IF EXISTS "Admins can delete any payment" ON public.payments;
CREATE POLICY "Admins can delete any payment" ON public.payments FOR DELETE USING (has_role(auth.uid(), ''admin''))';
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'referrals' AND policyname = 'Admins can insert referrals') THEN
    EXECUTE 'DROP POLICY IF EXISTS "Admins can insert referrals" ON public.referrals;
CREATE POLICY "Admins can insert referrals" ON public.referrals FOR INSERT WITH CHECK (has_role(auth.uid(), ''admin''))';
  END IF;
  
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'referrals' AND policyname = 'Admins can update referrals') THEN
    EXECUTE 'DROP POLICY IF EXISTS "Admins can update referrals" ON public.referrals;
CREATE POLICY "Admins can update referrals" ON public.referrals FOR UPDATE USING (has_role(auth.uid(), ''admin''))';
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'referrals' AND policyname = 'Admins can delete referrals') THEN
    EXECUTE 'DROP POLICY IF EXISTS "Admins can delete referrals" ON public.referrals;
CREATE POLICY "Admins can delete referrals" ON public.referrals FOR DELETE USING (has_role(auth.uid(), ''admin''))';
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'referral_commissions' AND policyname = 'Admins can insert referral commissions') THEN
    EXECUTE 'DROP POLICY IF EXISTS "Admins can insert referral commissions" ON public.referral_commissions;
CREATE POLICY "Admins can insert referral commissions" ON public.referral_commissions FOR INSERT WITH CHECK (has_role(auth.uid(), ''admin''))';
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'referral_commissions' AND policyname = 'Admins can update referral commissions') THEN
    EXECUTE 'DROP POLICY IF EXISTS "Admins can update referral commissions" ON public.referral_commissions;
CREATE POLICY "Admins can update referral commissions" ON public.referral_commissions FOR UPDATE USING (has_role(auth.uid(), ''admin''))';
  END IF;
  ...
  IF NOT EXISTS (SELECT 1 FROM pg_policies WHERE tablename = 'referral_commissions' AND policyname = 'Admins can delete referral commissions') THEN
    EXECUTE 'DROP POLICY IF EXISTS "Admins can delete referral commissions" ON public.referral_commissions;
CREATE POLICY "Admins can delete referral commissions" ON public.referral_commissions FOR DELETE USING (has_role(auth.uid(), ''admin''))';
  END IF;
END $$;
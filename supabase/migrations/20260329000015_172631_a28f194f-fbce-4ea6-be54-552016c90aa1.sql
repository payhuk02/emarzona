...
DROP POLICY IF EXISTS "Published updates viewable" ON public.digital_product_updates;
CREATE POLICY "Published updates viewable" ON public.digital_product_updates FOR SELECT USING (is_published = true);
DROP TRIGGER IF EXISTS update_digital_product_updates_updated_at ON public.digital_product_updates;
...
DROP POLICY IF EXISTS "Store owners view downloads" ON public.digital_product_downloads;
...
DROP POLICY IF EXISTS "Users can insert downloads" ON public.digital_product_downloads;
...
DROP POLICY IF EXISTS "Store owners manage vendor conversations" ON public.vendor_conversations;
...
DROP POLICY IF EXISTS "Customers view own conversations" ON public.vendor_conversations;
CREATE POLICY "Customers view own conversations" ON public.vendor_conversations FOR SELECT USING (auth.uid() = customer_id);
DROP TRIGGER IF EXISTS update_vendor_conversations_updated_at ON public.vendor_conversations;
...
DROP POLICY IF EXISTS "Conversation participants view vendor messages" ON public.vendor_messages;
...
DROP POLICY IF EXISTS "Auth users send vendor messages" ON public.vendor_messages;
...
DROP POLICY IF EXISTS "Store owners manage gift cards" ON public.gift_cards;
...
DROP POLICY IF EXISTS "Users view own gift cards" ON public.gift_cards;
...
DROP POLICY IF EXISTS "Gift card transaction access" ON public.gift_card_transactions;
...
DROP POLICY IF EXISTS "Store owners manage loyalty" ON public.loyalty_points;
...
DROP POLICY IF EXISTS "Store owners manage loyalty transactions" ON public.loyalty_transactions;

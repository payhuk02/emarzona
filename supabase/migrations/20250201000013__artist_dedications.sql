...
DROP POLICY IF EXISTS "dedications_manage_admins" ON public.artist_product_dedications;
...
DROP POLICY IF EXISTS "dedication_templates_manage_admins" ON public.artist_dedication_templates;

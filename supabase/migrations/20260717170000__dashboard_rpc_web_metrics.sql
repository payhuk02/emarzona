-- P1 analytics: pageViews / bounce / sessionDuration via product_analytics pipeline tables
-- Extends get_store_dashboard_stats_aggregated with webMetrics (period-scoped).
...
-- Patch aggregated RPC: inject webMetrics before RETURN (full body from 20260714170000 + web block).

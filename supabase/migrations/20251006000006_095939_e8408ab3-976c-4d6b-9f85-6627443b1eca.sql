...
DROP POLICY IF EXISTS "Store owners can view their promotions" ON public.promotions;
...
DROP POLICY IF EXISTS "Store owners can create promotions" ON public.promotions;
...
DROP POLICY IF EXISTS "Store owners can update their promotions" ON public.promotions;
...
DROP POLICY IF EXISTS "Store owners can delete their promotions" ON public.promotions;

...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_sales_history_store_id ON public.sales_history(store_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_sales_history_sale_date ON public.sales_history(sale_date);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_demand_forecasts_forecast_date ON public.demand_forecasts(forecast_date);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS update_demand_forecasts_updated_at ON public.demand_forecasts;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_forecast_accuracy_forecast_id ON public.forecast_accuracy(forecast_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF EXISTS (
    ...
    DROP FUNCTION IF EXISTS public.calculate_forecast_accuracy_metrics();
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS calculate_forecast_accuracy_metrics_trigger ON public.forecast_accuracy;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_reorder_recommendations_store_id ON public.reorder_recommendations(store_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_reorder_recommendations_status ON public.reorder_recommendations(status);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_reorder_recommendations_priority ON public.reorder_recommendations(priority);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS update_reorder_recommendations_updated_at ON public.reorder_recommendations;
...
DO $$ BEGIN
  IF EXISTS (
    ...
    DROP FUNCTION IF EXISTS public.calculate_moving_average_forecast(UUID, UUID, UUID, INTEGER, DATE);
  END IF;
END $$;
...
DO $$ BEGIN
  IF EXISTS (
    ...
    DROP FUNCTION IF EXISTS public.calculate_exponential_smoothing_forecast(UUID, UUID, UUID, NUMERIC, DATE);
  END IF;
END $$;
...
DO $$ BEGIN
  IF EXISTS (
    ...
    DROP FUNCTION IF EXISTS public.generate_reorder_recommendations(UUID);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Store owners can manage sales history" ON public.sales_history;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Store owners can manage forecasts" ON public.demand_forecasts;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Store owners can manage recommendations" ON public.reorder_recommendations;

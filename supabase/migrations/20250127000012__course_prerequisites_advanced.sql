...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_prerequisites_type ON public.course_prerequisites(prerequisite_type);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS update_prerequisites_updated_at ON public.course_prerequisites;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE TABLE IF NOT EXISTS public.course_prerequisite_validations (
      id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_prerequisite_validations_prerequisite_id ON public.course_prerequisite_validations(prerequisite_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_prerequisite_validations_enrollment_id ON public.course_prerequisite_validations(enrollment_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS update_prerequisite_validations_updated_at ON public.course_prerequisite_validations;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Instructors can manage prerequisites" ON public.course_prerequisites;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Students can view prerequisites" ON public.course_prerequisites;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Users can view own validations" ON public.course_prerequisite_validations;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS trigger_auto_validate_prerequisites ON public.course_enrollments;

...
DROP POLICY IF EXISTS "Public can view approved members" ON public.community_members;
...
DROP POLICY IF EXISTS "Authenticated users can create member profile" ON public.community_members;
...
DROP POLICY IF EXISTS "Users can update own profile, admins can update any" ON public.community_members;
...
DROP POLICY IF EXISTS "Public can view published posts" ON public.community_posts;
...
DROP POLICY IF EXISTS "Approved members can create posts" ON public.community_posts;
...
DROP POLICY IF EXISTS "Authors can update own posts, admins can update any" ON public.community_posts;
...
DROP POLICY IF EXISTS "Public can view published comments" ON public.community_comments;
...
DROP POLICY IF EXISTS "Approved members can create comments" ON public.community_comments;
...
DROP POLICY IF EXISTS "Authors can update own comments, admins can update any" ON public.community_comments;

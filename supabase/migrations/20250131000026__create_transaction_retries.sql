...
DROP POLICY IF EXISTS "Store owners can view their transaction retries" ON public.transaction_retries;
...
DROP POLICY IF EXISTS "Admins can view all transaction retries" ON public.transaction_retries;

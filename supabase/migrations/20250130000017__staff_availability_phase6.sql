...
-- Trigger updated_at
DROP TRIGGER IF EXISTS update_staff_time_off_updated_at ON public.staff_time_off;
...
-- Trigger updated_at
DROP TRIGGER IF EXISTS update_staff_custom_hours_updated_at ON public.staff_custom_hours;
...
-- Trigger updated_at
DROP TRIGGER IF EXISTS update_staff_workload_alerts_updated_at ON public.staff_workload_alerts;
...
-- Trigger updated_at
DROP TRIGGER IF EXISTS update_resource_conflicts_updated_at ON public.resource_conflicts;

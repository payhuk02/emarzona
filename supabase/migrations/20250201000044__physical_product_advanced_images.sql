...
DROP TRIGGER IF EXISTS update_physical_product_images_updated_at ON public.physical_product_images;
...
DROP POLICY IF EXISTS "physical_product_images_select_public" ON public.physical_product_images;
...
DROP POLICY IF EXISTS "physical_product_images_manage_owners" ON public.physical_product_images;
...
DROP POLICY IF EXISTS "physical_product_images_manage_admins" ON public.physical_product_images;

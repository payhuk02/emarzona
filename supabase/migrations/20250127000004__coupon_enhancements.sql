...
DROP POLICY IF EXISTS "Store owners can view coupon usage" ON public.coupon_customer_usage;
...
DROP POLICY IF EXISTS "Customers can view own coupon usage" ON public.coupon_customer_usage;

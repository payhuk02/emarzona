...
DROP POLICY IF EXISTS "rls_digital_product_licenses" ON public.digital_product_licenses;
...
DROP POLICY IF EXISTS "rls_digital_product_coupons" ON public.digital_product_coupons;
...
DROP POLICY IF EXISTS "rls_digital_product_bundles" ON public.digital_product_bundles;
...
DROP POLICY IF EXISTS "rls_digital_product_webhooks" ON public.digital_product_webhooks;
...
DROP POLICY IF EXISTS "rls_read_digital_product_webhook_logs" ON public.digital_product_webhook_logs;
...
DROP POLICY IF EXISTS "rls_digital_product_subscriptions" ON public.digital_product_subscriptions;
...
DROP POLICY IF EXISTS "rls_digital_product_file_versions" ON public.digital_product_file_versions;
...
DROP POLICY IF EXISTS "rls_digital_product_file_metadata" ON public.digital_product_file_metadata;
...
DROP POLICY IF EXISTS "rls_digital_product_file_categories" ON public.digital_product_file_categories;
...
DROP POLICY IF EXISTS "rls_digital_product_drip_schedule" ON public.digital_product_drip_schedule;
...
DROP POLICY IF EXISTS "rls_digital_product_update_notifications" ON public.digital_product_update_notifications;
...
DROP POLICY IF EXISTS "rls_digital_license_activations" ON public.digital_license_activations;
...
DROP POLICY IF EXISTS "rls_digital_bundles" ON public.digital_bundles;
...
DROP POLICY IF EXISTS "rls_download_logs" ON public.download_logs;
...
DROP POLICY IF EXISTS "rls_license_events_read" ON public.license_events;
...
DROP POLICY IF EXISTS "rls_license_events_insert" ON public.license_events;
CREATE POLICY "rls_license_events_insert" ON public.license_events FOR INSERT TO authenticated WITH CHECK (true);
DROP POLICY IF EXISTS "rls_version_download_logs" ON public.version_download_logs;
CREATE POLICY "rls_version_download_logs" ON public.version_download_logs FOR ALL TO authenticated USING (user_id = auth.uid());
DROP POLICY IF EXISTS "rls_version_download_errors" ON public.version_download_errors;
...
DROP POLICY IF EXISTS "rls_version_rollback_logs" ON public.version_rollback_logs;
...
DROP POLICY IF EXISTS "rls_expiration_alerts" ON public.expiration_alerts;
CREATE POLICY "rls_expiration_alerts" ON public.expiration_alerts FOR ALL TO authenticated USING (user_id = auth.uid());
DROP POLICY IF EXISTS "rls_secured_payments" ON public.secured_payments;
...
DROP POLICY IF EXISTS "rls_product_reviews_public" ON public.product_reviews;
CREATE POLICY "rls_product_reviews_public" ON public.product_reviews FOR SELECT USING (is_approved = true);
DROP POLICY IF EXISTS "rls_product_reviews_manage" ON public.product_reviews;
...
DROP POLICY IF EXISTS "rls_product_clicks_insert" ON public.product_clicks;
CREATE POLICY "rls_product_clicks_insert" ON public.product_clicks FOR INSERT WITH CHECK (true);
DROP POLICY IF EXISTS "rls_product_clicks_read" ON public.product_clicks;
...
DROP POLICY IF EXISTS "rls_product_versions" ON public.product_versions;
...
DROP POLICY IF EXISTS "rls_product_size_charts" ON public.product_size_charts;
...
DROP POLICY IF EXISTS "rls_product_costs" ON public.product_costs;
...
DROP POLICY IF EXISTS "rls_product_kits" ON public.product_kits;
...
DROP POLICY IF EXISTS "rls_kit_components" ON public.kit_components;
...
DROP POLICY IF EXISTS "rls_kit_assemblies" ON public.kit_assemblies;
...
DROP POLICY IF EXISTS "rls_product_promotions" ON public.product_promotions;
...
DROP POLICY IF EXISTS "rls_promotion_usage_read" ON public.promotion_usage;
...
DROP POLICY IF EXISTS "rls_promotion_usage_insert" ON public.promotion_usage;
...
DROP POLICY IF EXISTS "rls_product_bundles" ON public.product_bundles;
...
DROP POLICY IF EXISTS "rls_bundle_items" ON public.bundle_items;
...
DROP POLICY IF EXISTS "rls_product_templates" ON public.product_templates;
...
DROP POLICY IF EXISTS "rls_product_return_policies" ON public.product_return_policies;
...
DROP POLICY IF EXISTS "rls_return_policies" ON public.return_policies;
...
DROP POLICY IF EXISTS "rls_variant_images_public" ON public.variant_images;
CREATE POLICY "rls_variant_images_public" ON public.variant_images FOR SELECT USING (true);
DROP POLICY IF EXISTS "rls_variant_images_manage" ON public.variant_images;
...
DROP POLICY IF EXISTS "rls_inventory_items" ON public.inventory_items;
...
DROP POLICY IF EXISTS "rls_auto_reorder_rules" ON public.auto_reorder_rules;
...
DROP POLICY IF EXISTS "rls_lot_movements" ON public.lot_movements;
...
DROP POLICY IF EXISTS "rls_lot_transfers" ON public.lot_transfers;
...
DROP POLICY IF EXISTS "rls_serial_number_history" ON public.serial_number_history;
...
DROP POLICY IF EXISTS "rls_demand_forecasts" ON public.demand_forecasts;
...
DROP POLICY IF EXISTS "rls_reorder_suggestions" ON public.reorder_suggestions;
...
DROP POLICY IF EXISTS "rls_stock_rotation_reports" ON public.stock_rotation_reports;
...
DROP POLICY IF EXISTS "rls_warehouse_inventory" ON public.warehouse_inventory;
...
DROP POLICY IF EXISTS "rls_warehouse_locations" ON public.warehouse_locations;
...
DROP POLICY IF EXISTS "rls_warehouse_transfers" ON public.warehouse_transfers;
...
DROP POLICY IF EXISTS "rls_warehouse_transfer_items" ON public.warehouse_transfer_items;
...
DROP POLICY IF EXISTS "rls_warehouse_allocations" ON public.warehouse_allocations;
...
DROP POLICY IF EXISTS "rls_warehouse_performance" ON public.warehouse_performance;
...
DROP POLICY IF EXISTS "rls_supplier_orders" ON public.supplier_orders;
...
DROP POLICY IF EXISTS "rls_supplier_order_items" ON public.supplier_order_items;
...
DROP POLICY IF EXISTS "rls_supplier_products" ON public.supplier_products;

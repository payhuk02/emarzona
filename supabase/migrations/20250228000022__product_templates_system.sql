...
DROP TRIGGER IF EXISTS product_templates_updated_at ON public.product_templates;
...
DROP POLICY IF EXISTS "Public can view public templates" ON public.product_templates;
...
DROP POLICY IF EXISTS "Users can view their own templates" ON public.product_templates;
...
DROP POLICY IF EXISTS "Users can create templates" ON public.product_templates;
...
DROP POLICY IF EXISTS "Users can update their own templates" ON public.product_templates;
...
DROP POLICY IF EXISTS "Users can delete their own templates" ON public.product_templates;
...
DROP POLICY IF EXISTS "Users can view updates of their products" ON public.digital_product_updates;

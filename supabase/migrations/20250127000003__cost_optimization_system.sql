...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_product_costs_store_id ON public.product_costs(store_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF EXISTS (
    ...
    DROP FUNCTION IF EXISTS public.calculate_total_cost_per_unit();
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS calculate_total_cost_per_unit_trigger ON public.product_costs;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE TABLE IF NOT EXISTS public.margin_analysis (
      id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
      store_id UUID NOT NULL REFERENCES public.stores(id) ON DELETE CASCADE,
      product_id UUID NOT NULL REFERENCES public.products(id) ON DELETE CASCADE,
      variant_id UUID REFERENCES public.product_variants(id) ON DELETE CASCADE,
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_margin_analysis_store_id ON public.margin_analysis(store_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_margin_analysis_product_id ON public.margin_analysis(product_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_margin_analysis_period ON public.margin_analysis(analysis_period_start, analysis_period_end);
  END IF;
END $$;
...
DO $$ BEGIN
  IF EXISTS (
    ...
    DROP FUNCTION IF EXISTS public.calculate_margin_metrics();
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS calculate_margin_metrics_trigger ON public.margin_analysis;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS update_margin_analysis_updated_at ON public.margin_analysis;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE TABLE IF NOT EXISTS public.price_optimization_recommendations (
      id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
      store_id UUID NOT NULL REFERENCES public.stores(id) ON DELETE CASCADE,
      product_id UUID NOT NULL REFERENCES public.products(id) ON DELETE CASCADE,
      variant_id UUID REFERENCES public.product_variants(id) ON DELETE CASCADE,
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_price_optimization_store_id ON public.price_optimization_recommendations(store_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_price_optimization_status ON public.price_optimization_recommendations(status);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_price_optimization_priority ON public.price_optimization_recommendations(priority);
  END IF;
END $$;
...
DO $$ BEGIN
  IF EXISTS (
    ...
    DROP FUNCTION IF EXISTS public.calculate_price_change_percentage();
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS calculate_price_change_percentage_trigger ON public.price_optimization_recommendations;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS update_price_optimization_updated_at ON public.price_optimization_recommendations;
...
DO $$ BEGIN
  IF EXISTS (
    ...
    DROP FUNCTION IF EXISTS public.calculate_product_margin(UUID, UUID, UUID, DATE, DATE);
  END IF;
END $$;
...
DO $$ BEGIN
  IF EXISTS (
    ...
    DROP FUNCTION IF EXISTS public.generate_price_optimization_recommendations(UUID);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Store owners can manage costs" ON public.product_costs;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Store owners can view analysis" ON public.margin_analysis;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Store owners can manage recommendations" ON public.price_optimization_recommendations;

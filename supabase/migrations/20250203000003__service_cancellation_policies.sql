...
DROP TRIGGER IF EXISTS update_service_cancellation_policies_updated_at ON public.service_cancellation_policies;
...
DROP TRIGGER IF EXISTS update_service_cancellation_refunds_updated_at ON public.service_cancellation_refunds;
...
BEGIN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'stores') THEN
    IF NOT EXISTS (
      ...
      EXECUTE '
        DROP POLICY IF EXISTS "Store owners can manage cancellation policies" ON public.service_cancellation_policies;
CREATE POLICY "Store owners can manage cancellation policies"
  ...
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'service_bookings') THEN
    IF NOT EXISTS (
      ...
      EXECUTE '
        DROP POLICY IF EXISTS "Users can view their own refunds" ON public.service_cancellation_refunds;
CREATE POLICY "Users can view their own refunds"
  ...
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'stores')
    ...
    IF NOT EXISTS (
      ...
      EXECUTE '
        DROP POLICY IF EXISTS "Store owners can manage refunds" ON public.service_cancellation_refunds;

-- Fix request_store_withdrawal: store_withdrawals has no user_id column
-- (INSERT ... user_id caused 400 Bad Request from PostgREST).
...
COMMENT ON FUNCTION public.request_store_withdrawal(UUID, NUMERIC, TEXT, JSONB, TEXT) IS
  'Seller withdrawal request; any positive amount up to available_balance minus other pending. No user_id column on store_withdrawals.';

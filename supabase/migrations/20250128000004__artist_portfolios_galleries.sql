...
DROP TRIGGER IF EXISTS update_gallery_artwork_count_trigger ON public.artist_gallery_artworks;
...
DROP TRIGGER IF EXISTS update_portfolio_artwork_count_trigger ON public.artist_gallery_artworks;
...
DROP TRIGGER IF EXISTS update_portfolio_view_count_trigger ON public.artist_portfolio_views;
...
DROP TRIGGER IF EXISTS update_portfolio_like_count_trigger ON public.artist_portfolio_likes;

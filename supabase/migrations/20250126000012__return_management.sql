...
DROP TRIGGER IF EXISTS set_return_number_trigger ON public.product_returns;
...
DROP POLICY IF EXISTS "Customers can update own returns" ON public.product_returns;
...
DROP POLICY IF EXISTS "Store owners can view their returns" ON public.product_returns;
...
DROP POLICY IF EXISTS "Store owners can update their returns" ON public.product_returns;
...
DROP POLICY IF EXISTS "Users can view return history for accessible returns" ON public.return_history;

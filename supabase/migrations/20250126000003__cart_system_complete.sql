...
DROP TRIGGER IF EXISTS trigger_update_abandoned_carts_updated_at ON public.abandoned_carts;
...
DROP POLICY IF EXISTS "Service can create abandoned carts" ON public.abandoned_carts;

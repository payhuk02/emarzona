...
CREATE INDEX IF NOT EXISTS idx_bundles_store_id ON public.digital_bundles(store_id);
CREATE INDEX IF NOT EXISTS idx_bundles_status ON public.digital_bundles(status);
CREATE INDEX IF NOT EXISTS idx_bundles_slug ON public.digital_bundles(store_id, slug);
CREATE INDEX IF NOT EXISTS idx_bundles_is_available ON public.digital_bundles(is_available);
CREATE INDEX IF NOT EXISTS idx_bundles_start_date ON public.digital_bundles(start_date);
CREATE INDEX IF NOT EXISTS idx_bundles_end_date ON public.digital_bundles(end_date);
CREATE INDEX IF NOT EXISTS idx_bundles_total_sales ON public.digital_bundles(total_sales DESC);
CREATE INDEX IF NOT EXISTS idx_bundles_conversion_rate ON public.digital_bundles(conversion_rate DESC);
CREATE INDEX IF NOT EXISTS idx_bundles_is_featured ON public.digital_bundles(is_featured);

-- ============================================================================
-- 2.2 TABLE: digital_bundle_items
-- ============================================================================

CREATE TABLE IF NOT EXISTS public.digital_bundle_items (
  -- Identifiants
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- Index
CREATE INDEX IF NOT EXISTS idx_bundle_items_bundle_id ON public.digital_bundle_items(bundle_id);
CREATE INDEX IF NOT EXISTS idx_bundle_items_product_id ON public.digital_bundle_items(product_id);
CREATE INDEX IF NOT EXISTS idx_bundle_items_order ON public.digital_bundle_items(bundle_id, order_index);
...
-- Trigger
DROP TRIGGER IF EXISTS update_digital_bundles_updated_at ON public.digital_bundles;
...
DROP TRIGGER IF EXISTS update_bundle_pricing_on_items_change ON public.digital_bundle_items;

...
DROP POLICY IF EXISTS "Store owners can manage own workflows" ON public.email_workflows;
...
DROP POLICY IF EXISTS "Admins can manage all workflows" ON public.email_workflows;

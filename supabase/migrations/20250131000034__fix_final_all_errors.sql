...
CREATE TRIGGER update_cohort_student_count_trigger
  ...
  IF EXISTS (
    ...
    IF NOT EXISTS (
      ...
      DROP TRIGGER IF EXISTS update_calendar_integrations_updated_at ON public.service_calendar_integrations;
CREATE TRIGGER update_calendar_integrations_updated_at
  ...
  IF EXISTS (
    ...
    IF NOT EXISTS (
      ...
      DROP TRIGGER IF EXISTS update_calendar_events_updated_at ON public.service_calendar_events;

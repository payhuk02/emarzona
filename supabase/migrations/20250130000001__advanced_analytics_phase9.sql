...
DROP TRIGGER IF EXISTS update_advanced_dashboards_updated_at ON public.advanced_analytics_dashboards;
...
DROP TRIGGER IF EXISTS update_analytics_alerts_updated_at ON public.analytics_alerts;

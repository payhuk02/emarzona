...
DROP POLICY IF EXISTS "Store owners can manage service products" ON public.service_products;
...
DROP POLICY IF EXISTS "Availability slots viewable by everyone" ON public.service_availability_slots;
CREATE POLICY "Availability slots viewable by everyone" ON public.service_availability_slots FOR SELECT USING (true);
DROP POLICY IF EXISTS "Store owners can manage availability" ON public.service_availability_slots;
...
DROP POLICY IF EXISTS "Staff viewable by everyone" ON public.service_staff_members;
CREATE POLICY "Staff viewable by everyone" ON public.service_staff_members FOR SELECT USING (true);
DROP POLICY IF EXISTS "Store owners can manage staff" ON public.service_staff_members;
...
DROP POLICY IF EXISTS "Resources viewable by everyone" ON public.service_resources;
CREATE POLICY "Resources viewable by everyone" ON public.service_resources FOR SELECT USING (true);
DROP POLICY IF EXISTS "Store owners can manage resources" ON public.service_resources;
...
DROP POLICY IF EXISTS "Store owners can manage service bookings" ON public.service_bookings;
...
DROP TRIGGER IF EXISTS update_service_availability_slots_updated_at ON public.service_availability_slots;
...
DROP TRIGGER IF EXISTS update_service_staff_members_updated_at ON public.service_staff_members;
...
DROP TRIGGER IF EXISTS update_service_resources_updated_at ON public.service_resources;

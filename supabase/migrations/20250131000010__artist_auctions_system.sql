...
DROP TRIGGER IF EXISTS update_auctions_updated_at ON public.artist_product_auctions;
...
DROP POLICY IF EXISTS "Public can view active auctions" ON public.artist_product_auctions;
...
DROP POLICY IF EXISTS "Store owners can manage their auctions" ON public.artist_product_auctions;
...
DROP POLICY IF EXISTS "Users can view their bids and public bids" ON public.auction_bids;
...
DROP POLICY IF EXISTS "Users can update their bids" ON public.auction_bids;
...
DROP POLICY IF EXISTS "Users can manage their watchlist" ON public.auction_watchlist;

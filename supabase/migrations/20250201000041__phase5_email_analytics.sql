...
DROP TRIGGER IF EXISTS update_email_analytics_daily_updated_at ON public.email_analytics_daily;
...
DROP POLICY IF EXISTS "Store owners can view own analytics" ON public.email_analytics_daily;
...
DROP POLICY IF EXISTS "Admins can view all analytics" ON public.email_analytics_daily;

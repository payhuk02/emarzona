-- Ensure get_or_create_store_notification_settings exists (prod/E2E drift).
-- Trigger trg_seed_store_notification_settings calls it on every stores INSERT;
-- missing RPC → 42883 and store create failure via PostgREST.

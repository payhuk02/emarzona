...
BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_currencies_base ON public.currencies(is_base_currency);
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_exchange_rates_from ON public.exchange_rates(from_currency);
    CREATE INDEX IF NOT EXISTS idx_exchange_rates_to ON public.exchange_rates(to_currency);
    CREATE INDEX IF NOT EXISTS idx_exchange_rates_active ON public.exchange_rates(is_active);
    CREATE INDEX IF NOT EXISTS idx_exchange_rates_last_updated ON public.exchange_rates(last_updated DESC);
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_regional_prices_product ON public.regional_prices(product_id);
    CREATE INDEX IF NOT EXISTS idx_regional_prices_currency ON public.regional_prices(currency_code);
    CREATE INDEX IF NOT EXISTS idx_regional_prices_active ON public.regional_prices(is_active);
  END IF;
END $$;
...
BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_conversion_logs_from ON public.currency_conversion_logs(from_currency);
    CREATE INDEX IF NOT EXISTS idx_conversion_logs_to ON public.currency_conversion_logs(to_currency);
    CREATE INDEX IF NOT EXISTS idx_conversion_logs_created ON public.currency_conversion_logs(created_at DESC);
  END IF;
END $$;

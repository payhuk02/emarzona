...
BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS validate_artist_product_insert ON public.artist_products;
...
BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS validate_artist_product_update ON public.artist_products;

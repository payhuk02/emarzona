...
-- Policies: affiliates
DROP POLICY IF EXISTS "Users can view own affiliate profile" ON public.affiliates;
CREATE POLICY "Users can view own affiliate profile" ON public.affiliates FOR SELECT USING (auth.uid() = user_id);
DROP POLICY IF EXISTS "Users can create affiliate profile" ON public.affiliates;
CREATE POLICY "Users can create affiliate profile" ON public.affiliates FOR INSERT WITH CHECK (auth.uid() = user_id);
DROP POLICY IF EXISTS "Users can update own affiliate profile" ON public.affiliates;
...
DROP POLICY IF EXISTS "Affiliates can create links" ON public.affiliate_links;
...
DROP POLICY IF EXISTS "Affiliates can update own links" ON public.affiliate_links;
...
DROP POLICY IF EXISTS "Affiliate links viewable for tracking" ON public.affiliate_links;
...
DROP POLICY IF EXISTS "Store owners can manage commissions" ON public.affiliate_commissions;

...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS update_3d_models_updated_at ON public.artist_3d_models;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS update_provenance_updated_at ON public.artwork_provenance;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS update_certificates_updated_at ON public.artwork_certificates;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Store owners can manage 3D models" ON public.artist_3d_models;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Everyone can view 3D models" ON public.artist_3d_models;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Everyone can view provenance" ON public.artwork_provenance;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Store owners can manage certificates" ON public.artwork_certificates;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Everyone can view certificates" ON public.artwork_certificates;

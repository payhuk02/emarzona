...
DROP POLICY IF EXISTS "Store owners can create customers" ON public.customers;
...
DROP POLICY IF EXISTS "Store owners can create order items" ON public.order_items;

...
DROP POLICY IF EXISTS "Anon can manage session cart" ON public.cart_items;
...
DROP POLICY IF EXISTS "Authenticated can insert admin actions" ON public.admin_actions;
...
DROP POLICY IF EXISTS "Store owners can manage disputes" ON public.disputes;
...
DROP POLICY IF EXISTS "Store owners can manage webhooks" ON public.webhooks;
...
DROP POLICY IF EXISTS "Store owners can manage returns" ON public.product_returns;
...
DROP POLICY IF EXISTS "Public carriers viewable" ON public.shipping_carriers;

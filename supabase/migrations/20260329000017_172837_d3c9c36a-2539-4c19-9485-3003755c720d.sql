...
DROP POLICY IF EXISTS "Store owners manage suppliers" ON public.suppliers;
...
DROP POLICY IF EXISTS "Store owners manage digital alerts" ON public.digital_alerts;
...
DROP TRIGGER IF EXISTS update_digital_alerts_updated_at ON public.digital_alerts;
...
DROP POLICY IF EXISTS "Store owners manage backorders" ON public.backorders;
...
DROP POLICY IF EXISTS "Users view own backorders" ON public.backorders;
...
DROP POLICY IF EXISTS "Store owners manage taxes" ON public.tax_configurations;
...
DROP POLICY IF EXISTS "Store owners manage serials" ON public.serial_numbers;
...
DROP POLICY IF EXISTS "Store owners manage warranties" ON public.product_warranties;
...
DROP POLICY IF EXISTS "Warranties publicly viewable" ON public.product_warranties;
...
DROP POLICY IF EXISTS "Users view own claims" ON public.warranty_claims;
CREATE POLICY "Users view own claims" ON public.warranty_claims FOR SELECT USING (auth.uid() = user_id);
DROP POLICY IF EXISTS "Users create claims" ON public.warranty_claims;
CREATE POLICY "Users create claims" ON public.warranty_claims FOR INSERT TO authenticated WITH CHECK (auth.uid() = user_id);
DROP POLICY IF EXISTS "Store owners manage claims" ON public.warranty_claims;
...
DROP POLICY IF EXISTS "Store owners manage pre-orders" ON public.pre_orders;
...
DROP POLICY IF EXISTS "Users view own pre-orders" ON public.pre_orders;
...
DROP POLICY IF EXISTS "Store owners manage lots" ON public.product_lots;
...
DROP POLICY IF EXISTS "Affiliates manage own short links" ON public.affiliate_short_links;
...
DROP POLICY IF EXISTS "Active short links viewable" ON public.affiliate_short_links;
...
DROP POLICY IF EXISTS "Users view own waitlist" ON public.service_waitlist;
CREATE POLICY "Users view own waitlist" ON public.service_waitlist FOR SELECT USING (auth.uid() = user_id);
DROP TRIGGER IF EXISTS update_service_waitlist_updated_at ON public.service_waitlist;

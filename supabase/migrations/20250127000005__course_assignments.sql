...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_course_assignments_section_id ON public.course_assignments(section_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_assignment_submissions_assignment_id ON public.course_assignment_submissions(assignment_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_assignment_submissions_enrollment_id ON public.course_assignment_submissions(enrollment_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_assignment_submissions_user_id ON public.course_assignment_submissions(user_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_assignment_submissions_status ON public.course_assignment_submissions(status);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS update_assignment_submissions_updated_at ON public.course_assignment_submissions;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE TABLE IF NOT EXISTS public.course_assignment_grading (
      id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_assignment_grading_submission_id ON public.course_assignment_grading(submission_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Students can view visible assignments" ON public.course_assignments;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Students can view own submissions" ON public.course_assignment_submissions;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Students can create own submissions" ON public.course_assignment_submissions;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Students can update own draft submissions" ON public.course_assignment_submissions;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Instructors can view all submissions" ON public.course_assignment_submissions;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Instructors can grade submissions" ON public.course_assignment_submissions;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Students can view own grading" ON public.course_assignment_grading;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Instructors can manage grading" ON public.course_assignment_grading;

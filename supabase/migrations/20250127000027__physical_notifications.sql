...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_physical_alerts_store_id ON public.physical_product_alerts(store_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_physical_alerts_product_id ON public.physical_product_alerts(product_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_physical_alerts_type ON public.physical_product_alerts(alert_type);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_physical_alerts_status ON public.physical_product_alerts(status);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_physical_alerts_severity ON public.physical_product_alerts(severity);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS update_physical_alerts_updated_at ON public.physical_product_alerts;
...
DO $$ BEGIN
  IF EXISTS (
    ...
    CREATE INDEX IF NOT EXISTS idx_notification_prefs_store_user ON public.notification_preferences(store_id, user_id);
  END IF;
END $$;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Store owners can manage alerts" ON public.physical_product_alerts;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP POLICY IF EXISTS "Store owners can view logs" ON public.notification_logs;
...
DO $$ BEGIN
  IF NOT EXISTS (
    ...
    DROP TRIGGER IF EXISTS trigger_check_low_stock_alert ON public.inventory_items;

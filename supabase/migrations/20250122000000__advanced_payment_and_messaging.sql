...
DROP POLICY IF EXISTS "Store owners can view their partial payments" ON public.partial_payments;
...
DROP POLICY IF EXISTS "Customers can view their partial payments" ON public.partial_payments;
...
DROP POLICY IF EXISTS "Store owners can view their secured payments" ON public.secured_payments;
...
DROP POLICY IF EXISTS "Store owners can view their conversations" ON public.conversations;
...
DROP POLICY IF EXISTS "Store owners can create conversations" ON public.conversations;
...
DROP POLICY IF EXISTS "Dispute participants can view disputes" ON public.disputes;
...
DROP TRIGGER IF EXISTS create_conversation_on_order_creation ON public.orders;
...
DROP TRIGGER IF EXISTS calculate_remaining_amount_trigger ON public.orders;
...
DROP TRIGGER IF EXISTS update_partial_payments_updated_at ON public.partial_payments;
CREATE TRIGGER update_partial_payments_updated_at
  BEFORE UPDATE ON public.partial_payments
  FOR EACH ROW
  EXECUTE FUNCTION public.update_updated_at_column();

DROP TRIGGER IF EXISTS update_secured_payments_updated_at ON public.secured_payments;

...
-- Indexes
CREATE INDEX IF NOT EXISTS idx_product_affiliate_settings_product_id ON public.product_affiliate_settings(product_id);
CREATE INDEX IF NOT EXISTS idx_product_affiliate_settings_store_id ON public.product_affiliate_settings(store_id);
CREATE INDEX IF NOT EXISTS idx_product_affiliate_settings_enabled ON public.product_affiliate_settings(affiliate_enabled) WHERE affiliate_enabled = true;
...
DROP POLICY IF EXISTS "Store owners can manage their product affiliate settings" ON public.product_affiliate_settings;
...
DROP POLICY IF EXISTS "Anyone can view affiliate-enabled products" ON public.product_affiliate_settings;
...
DROP POLICY IF EXISTS "Admins can view all settings" ON public.product_affiliate_settings;
...
DROP POLICY IF EXISTS "Affiliates can create links for affiliate-enabled products" ON public.affiliate_links;
...
DROP POLICY IF EXISTS "Store owners can view links for their products" ON public.affiliate_links;
...
CREATE INDEX IF NOT EXISTS idx_affiliate_clicks_order_id ON public.affiliate_clicks(order_id) WHERE order_id IS NOT NULL;
...
DROP POLICY IF EXISTS "No direct user access to clicks" ON public.affiliate_clicks;
...
CREATE INDEX IF NOT EXISTS idx_affiliate_commissions_store_id ON public.affiliate_commissions(store_id);
...
DROP POLICY IF EXISTS "Store owners can view commissions for their products" ON public.affiliate_commissions;
...
DROP POLICY IF EXISTS "Store owners can approve/reject commissions" ON public.affiliate_commissions;
...
CREATE INDEX IF NOT EXISTS idx_affiliate_withdrawals_created_at ON public.affiliate_withdrawals(created_at DESC);
...
DROP POLICY IF EXISTS "Affiliates can create their own withdrawals" ON public.affiliate_withdrawals;

-- Produits physiques : pas de frais checkout acheteur (2%+100).
-- La commission vendeur 10% est déjà à 0% (C1). Les frais 2%+100 restent
-- sur digital/service/course/artist et sur les abonnements vendeur physiques (client).
...
BEGIN
  ...
  -- Pas de frais checkout 2%+100 sur les ventes produits physiques
...
COMMENT ON FUNCTION public.create_public_physical_order IS
  'Checkout public produit physique — total = sous-total (pas de frais acheteur 2%+100).';

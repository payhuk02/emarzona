...
CREATE INDEX IF NOT EXISTS idx_licenses_product_id ON public.digital_product_licenses(product_id);
CREATE INDEX IF NOT EXISTS idx_licenses_order_id ON public.digital_product_licenses(order_id);
CREATE INDEX IF NOT EXISTS idx_licenses_customer_id ON public.digital_product_licenses(customer_id);
CREATE INDEX IF NOT EXISTS idx_licenses_store_id ON public.digital_product_licenses(store_id);
CREATE INDEX IF NOT EXISTS idx_licenses_key ON public.digital_product_licenses(license_key);
CREATE INDEX IF NOT EXISTS idx_licenses_status ON public.digital_product_licenses(status);
CREATE INDEX IF NOT EXISTS idx_licenses_expires_at ON public.digital_product_licenses(expires_at);
...
CREATE INDEX IF NOT EXISTS idx_activations_status ON public.license_activations(status);
CREATE INDEX IF NOT EXISTS idx_activations_device ON public.license_activations(device_fingerprint);
CREATE INDEX IF NOT EXISTS idx_activations_ip ON public.license_activations(ip_address);
...
-- Index
CREATE INDEX IF NOT EXISTS idx_events_license_id ON public.license_events(license_id);
CREATE INDEX IF NOT EXISTS idx_events_type ON public.license_events(event_type);
CREATE INDEX IF NOT EXISTS idx_events_created_at ON public.license_events(created_at DESC);
...
-- Triggers
DROP TRIGGER IF EXISTS update_licenses_updated_at ON public.digital_product_licenses;
CREATE TRIGGER update_licenses_updated_at
  BEFORE UPDATE ON public.digital_product_licenses
  FOR EACH ROW EXECUTE FUNCTION update_license_updated_at();

DROP TRIGGER IF EXISTS update_activations_updated_at ON public.license_activations;
...
DROP POLICY IF EXISTS "Vendors can view their licenses" ON public.digital_product_licenses;
...
DROP POLICY IF EXISTS "Customers can view their licenses" ON public.digital_product_licenses;
...
DROP POLICY IF EXISTS "Vendors can create licenses" ON public.digital_product_licenses;
...
DROP POLICY IF EXISTS "Vendors can update their licenses" ON public.digital_product_licenses;
...
DROP POLICY IF EXISTS "Users can view activations" ON public.license_activations;
...
DROP POLICY IF EXISTS "Customers can create activations" ON public.license_activations;
...
DROP POLICY IF EXISTS "Users can view events" ON public.license_events;

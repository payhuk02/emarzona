...
DROP POLICY IF EXISTS "Users can create their own commission payment requests" ON public.commission_payments;
CREATE POLICY "Users can create their own commission payment requests"
  ON public.commission_payments FOR INSERT
  WITH CHECK (auth.uid() = referrer_id);

DROP POLICY IF EXISTS "Admins can view all commission payments" ON public.commission_payments;

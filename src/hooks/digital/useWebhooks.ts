...
const DIGITAL_WEBHOOK_FIELDS = 'id, store_id, name, url, events, secret_key, is_active, retry_count, timeout_seconds, headers, total_sent, total_succeeded, total_failed, last_sent_at, description, metadata, created_by, created_at, updated_at';
const WEBHOOK_LOG_FIELDS = 'id, webhook_id, event_type, event_id, payload, response_status, response_body, response_headers, attempts, success, error_message, error_code, sent_at, duration_ms, metadata';

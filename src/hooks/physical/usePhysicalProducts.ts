...
const PHYSICAL_PRODUCT_FIELDS = 'id, store_id, name, sku, barcode, image_url, description, price, currency, has_variants, track_inventory, total_quantity, low_stock_threshold, is_active, created_at, updated_at';

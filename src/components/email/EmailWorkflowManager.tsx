...
import { Plus, MoreHorizontal, Edit, Trash2, Play, Pause, Archive } from 'lucide-react';
import { useEmailWorkflows, useDeleteEmailWorkflow, useUpdateEmailWorkflow } from '@/hooks/email/useEmailWorkflows';
import type { EmailWorkflow, WorkflowStatus } from '@/lib/email/email-workflow-service';
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Gérez vos workflows automatisés ({workflows?.length || 0})
              </CardDescription>
            </div>
                ...
                {workflows.map((workflow) => (
                  <TableRow key={workflow.id}>
                    ...
                    <TableCell>
                      <Badge
                        variant="outline"
                        className={cn(STATUS_COLORS[workflow.status])}
                      >
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Cette action ne peut pas être annulée. Cela supprimera définitivement ce workflow

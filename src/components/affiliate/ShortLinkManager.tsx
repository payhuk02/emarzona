...
export const ShortLinkManager = ({ affiliateLinkId, fullUrl: _fullUrl }: ShortLinkManagerProps) => {
  const {
    ...
    toggleShortLink,
    refetch: _refetch,
  } = useAffiliateShortLinks(affiliateLinkId);
  ...
  const [expirationType, setExpirationType] = useState<
    'none' | 'fixed_date' | 'duration' | 'clicks_limit' | 'combined'
  >('none');
  ...
  const [secondaryCondition, setSecondaryCondition] = useState<'date' | 'clicks' | 'duration'>(
    'clicks'
  );
  ...
  const handleToggle = useCallback(
    async (shortLinkId: string, isActive: boolean) => {
        ...
        <div className="flex items-center justify-between mb-4">
          <TabsList className="grid w-full max-w-md grid-cols-3">
            ...
            <TabsTrigger value="insights" className="gap-2">
              ...
              Insights
              {(insights?.suggestions?.total_suggestions ?? 0) > 0 && (
                ...
                {!customAlias.trim() && (
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      value={codeLength}
                      onChange={e =>
                        setCodeLength(Math.max(4, Math.min(10, parseInt(e.target.value) || 6)))
                      }
                    />
                    <p className="text-xs text-muted-foreground">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <RadioGroup
                      ...
                      onValueChange={value =>
                        setExpirationType(
                          value as 'none' | 'fixed_date' | 'duration' | 'clicks_limit' | 'combined'
                        )
                      }
                    >
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="fixed_date" className="text-sm">
                          Date fixe
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor="clicks_limit" className="text-sm">
                          Limite de clics
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2">
                    ...
                    <div className="space-y-4">
                      <div className="space-y-2">
                        ...
                        <RadioGroup
                          ...
                          onValueChange={value =>
                            setPrimaryCondition(value as 'date' | 'clicks' | 'duration')
                          }
                        >
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="date" id="primary_date" />
                            <Label htmlFor="primary_date" className="text-sm">
                              Date fixe
                            </Label>
                          </div>
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="duration" id="primary_duration" />
                            <Label htmlFor="primary_duration" className="text-sm">
                              Durée
                            </Label>
                          </div>
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="clicks" id="primary_clicks" />
                            <Label htmlFor="primary_clicks" className="text-sm">
                              Clics max
                            </Label>
                          </div>
                        </RadioGroup>
                      ...
                      <div className="space-y-2">
                        ...
                        <RadioGroup
                          ...
                          onValueChange={value =>
                            setSecondaryCondition(value as 'date' | 'clicks' | 'duration')
                          }
                        >
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="date" id="secondary_date" />
                            <Label htmlFor="secondary_date" className="text-sm">
                              Date fixe
                            </Label>
                          </div>
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="duration" id="secondary_duration" />
                            <Label htmlFor="secondary_duration" className="text-sm">
                              Durée
                            </Label>
                          </div>
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="clicks" id="secondary_clicks" />
                            <Label htmlFor="secondary_clicks" className="text-sm">
                              Clics max
                            </Label>
                          </div>
                        </RadioGroup>
                      ...
                      {(primaryCondition === 'clicks' || secondaryCondition === 'clicks') && (
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            value={maxClicks}
                            onChange={e =>
                              setMaxClicks(Math.max(1, parseInt(e.target.value) || 100))
                            }
                          />
                        </div>
                      )}
        ...
        {loading ? (
          ...
          <div className="text-center py-4 space-y-2">
            ...
            <p className="text-xs text-muted-foreground/70">
              💡 Les liens courts permettent de partager vos liens d'affiliation de manière plus
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Clics convertis</p>
            </CardContent>
          </Card>
        ...
        {analytics.top_performing_links.length > 0 && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Vos liens les plus populaires cette période</CardDescription>
            </CardHeader>
            <CardContent>
      ...
      return (
        <div className="text-center py-8 space-y-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Vos liens courts fonctionnent parfaitement. Aucune optimisation nécessaire pour le
              moment.
            </p>
          </div>
        </div>
                ...
                {suggestion.affected_links && suggestion.affected_links.length > 0 && (
                  <div>
                    ...
                    <div className="space-y-1">
                      {suggestion.affected_links.map(
                        (link: { short_code: string; clicks: number }, linkIndex: number) => (
                          <div
                            key={linkIndex}

...
export const SEOMeta = ({
  ...
  return (
    <Helmet>
      ...
      {/* Hreflang dynamiques basés sur l'URL réelle servie */}
      ...
      <link rel="alternate" hrefLang="x-default" href={safeString(url, window.location.origin)} />
      ...
      {/* Images OG */}
      <meta property="og:image" content={safeString(image, 'https://www.emarzona.com/og-image.png')} />
      ...
      <meta property="og:image:type" content={safeString(image, '').endsWith('.png') ? 'image/png' : 'image/jpeg'} />
      ...
      <meta name="twitter:image" content={safeString(image, 'https://www.emarzona.com/og-image.png')} />

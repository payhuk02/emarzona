...
const AVAILABLE_PAYMENT_PROVIDERS = [
...
export const StorePaymentSettings: React.FC<StorePaymentSettingsProps> = ({
  ...
  const [enabledProviders, setEnabledProviders] = useState<string[]>(
    store.enabled_payment_providers || ['moneroo', 'paydunya']
  );
  ...
  const handleSave = async () => {
    ...
    try {
      const updates: Record<string, unknown> = {
        ...
        enabled_payment_providers: enabledProviders.length > 0 ? enabledProviders : ['moneroo', 'paydunya'],
      };
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="maximum_order_amount">
                Montant maximum (en CFA)
              </Label>
              <Input
          ...
          <div className="space-y-2">
            <Label htmlFor="free_shipping_threshold">
              Seuil livraison gratuite (en CFA)
            </Label>
            <Input
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configurez les options supplémentaires de paiement
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configurez le format des factures générées
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      ...
      <Alert>
        ...
        <AlertDescription>
          Ces paramètres s'appliquent à toutes les commandes passées sur votre boutique.

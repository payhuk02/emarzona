...
export function UtilityBarHeader({ className }: UtilityBarHeaderProps) {
  ...
  return (
    <header
      ...
      data-testid="utility-bar-header"
    >
      <div className="flex items-center gap-1.5 sm:gap-2 min-w-0">
        <SidebarTrigger
          className="md:hidden shrink-0 touch-manipulation min-h-[44px] min-w-[44px] h-11 w-11"
          data-testid="utility-sidebar-trigger"
        />
      ...
      <div className="flex items-center gap-1 sm:gap-2 ml-auto shrink-0">
        ...
        <div className="flex items-center gap-1 sm:gap-2 mr-1 sm:mr-2 pr-2 border-r">
          ...
          <span className="sm:hidden text-[11px] font-medium text-muted-foreground">Expert</span>
          <Switch

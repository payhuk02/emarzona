    ...
    <Card>
      <CardHeader>
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#003087]/10 text-[#003087] font-bold text-sm">
              PP
            </div>
            <div>
              <CardTitle>PayPal Commerce</CardTitle>
              <CardDescription>
                Encaissez via PayPal (USD, EUR, GBP…) — fonds sur votre compte PayPal Business.
              </CardDescription>
            </div>
          </div>
      ...
      <CardContent className="space-y-4">
        ...
        {status === 'restricted' && (
          <Alert>
            <AlertDescription>
              PayPal demande des informations supplémentaires. Reprenez l&apos;onboarding pour
            ...
            <Button onClick={onConnect} disabled={isConnecting}>
              {isConnecting ? (
                ...
                <>
                  ...
                  {connection ? 'Compléter PayPal' : 'Connecter PayPal'}
                </>
              )}
            </Button>
          ) : (
        ...
        <p className="text-xs text-muted-foreground">
          Commission plateforme Emarzona prélevée automatiquement. L&apos;acheteur est redirigé vers
          PayPal pour payer en toute sécurité.
        </p>
      </CardContent>
    </Card>
  );

  ...
  return (
    <div className="p-6 bg-gray-100 rounded-lg">
      ...
      <div className="mb-4">
        ...
        <p>
          <strong>Route actuelle :</strong> {location.pathname}
        </p>
        <p>
      ...
      <div className="mb-4">
        ...
        <button onClick={testRefresh} className="bg-green-500 text-white px-4 py-2 rounded">
      ...
      {testResults.length > 0 && (
        <div className="mt-4">
          ...
          <div className="mt-4 p-3 bg-blue-100 rounded">
            ...
            <p>
              ✅ Succès: {testResults.filter(r => r.success).length}/{testResults.length}
            </p>
            <p>
              ❌ Échecs: {testResults.filter(r => !r.success).length}/{testResults.length}
            </p>
          </div>
        </div>
      )}

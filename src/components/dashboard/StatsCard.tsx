...
const StatsCardComponent = ({
  ...
  return (
    <Card
      className={`shadow-soft hover:shadow-medium transition-smooth hover-scale ${className}`}
    ...
    >
      ...
      <CardContent className="p-3 sm:p-4 md:p-6 pt-0">
        <div className="text-lg sm:text-xl md:text-2xl font-bold animate-fade-in break-words">
          {value}
        </div>
        {description && (

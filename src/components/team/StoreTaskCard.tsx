...
export const StoreTaskCard = memo(
                ...
                <div className="flex items-center gap-4 flex-wrap text-xs text-muted-foreground">
                  ...
                  {task.due_date && (
                    <div className="flex items-center gap-1">
                      ...
                      <span
                        className={cn(isOverdue && 'text-red-600 dark:text-red-400 font-medium')}
                      >
                ...
                {task.assigned_to_users && task.assigned_to_users.length > 0 && (
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-xs text-muted-foreground">
                      {task.assigned_to_users.length} membre
                      {task.assigned_to_users.length > 1 ? 's' : ''}
                    </span>
                  </div>
                )}
              </div>

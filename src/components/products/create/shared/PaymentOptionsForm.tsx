...
import { DEFAULT_SERVICE_CTA_LABEL } from '@/constants/service-checkout-options';
import { ServiceCtaButtonFields } from '../service/ServiceCtaButtonFields';
    ...
    <div className="space-y-6">
      ...
      {productType === 'service' && (
        <ServiceCtaButtonFields
          ...
          onChange={label => onUpdate({ ...data, cta_button_label: label })}
        />
      )}

...
const SERVICE_STAFF_MEMBER_FIELDS = 'id, service_product_id, name, is_active';
const SERVICE_RESOURCE_FIELDS = 'id, service_product_id, name, description, resource_type, quantity, is_required';

...
const SERVICE_STAFF_MEMBER_FIELDS = 'id, store_id, service_product_id, name, email, avatar_url, is_active';
const SERVICE_AVAILABILITY_SLOT_FIELDS = 'id, service_product_id, day_of_week, start_time, end_time, staff_member_id, is_active';
const STAFF_TIME_OFF_FIELDS = 'id, store_id, staff_member_id, start_date, end_date, start_time, end_time, status, time_off_type';
const STAFF_CUSTOM_HOURS_FIELDS = 'id, store_id, staff_member_id, specific_date, day_of_week, start_time, end_time, is_unavailable, is_active';

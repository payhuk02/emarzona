  ...
  const handleGenerateReport = useCallback(
    async (reportType: 'daily' | 'weekly' | 'monthly' | 'custom') => {
      try {
        ...
        logger.error('Erreur lors de la génération du rapport', { error, productId, reportType });
        toast({
          title: 'Erreur',
            ...
            <div className="space-y-2">
              ...
              >
                ...
                <SelectContent className="bg-gray-800 border-gray-600">
                  ...
                  <SelectItem value="xlsx" className="text-white hover:bg-gray-700">
                    Excel
                  </SelectItem>
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    ...
                    >
                      ...
                      {customStartDate
                        ? format(customStartDate, 'dd/MM/yyyy', { locale: fr })
                        : 'Sélectionner'}
                    </Button>
                  </PopoverTrigger>
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    ...
                    >
                      <CalendarIcon className="mr-2 h-4 w-4" />
                      {customEndDate
                        ? format(customEndDate, 'dd/MM/yyyy', { locale: fr })
                        : 'Sélectionner'}
                    </Button>
                  </PopoverTrigger>
                  <PopoverContent className="w-auto p-0 bg-gray-800 border-gray-600">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-400">
                        {format(new Date(report.start_date), 'dd/MM/yyyy', { locale: fr })} -{' '}

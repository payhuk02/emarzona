...
} from '@/hooks/physical/usePhysicalProducts';
...
import { Plus, Search, Package, TrendingUp, AlertTriangle, Filter } from 'lucide-react';
    ...
    <AppPageShell mainClassName="overflow-x-hidden">
      <div className="container mx-auto p-6 space-y-6">
        ...
        <Tabs defaultValue="all" className="w-full">
          <TabsList>
            <TabsTrigger value="all">Tous ({filteredProducts?.length || 0})</TabsTrigger>
            <TabsTrigger value="low-stock">Stock faible ({lowStockCount})</TabsTrigger>
            <TabsTrigger value="out-of-stock">Rupture ({outOfStockCount})</TabsTrigger>
          </TabsList>

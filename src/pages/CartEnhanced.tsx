        ...
        {summary.discount_amount > 0 && (
          <Alert className="border-green-500 bg-green-50 dark:bg-green-900/20 animate-in fade-in slide-in-from-top-2 duration-500">
            ...
            <AlertDescription className="text-green-800 dark:text-green-200">
              Félicitations ! Vous économisez {summary.discount_amount.toLocaleString('fr-FR')} XOF
              grâce à vos codes promo.
            </AlertDescription>
          </Alert>
        )}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <section className="lg:col-span-2 space-y-4" aria-label="Articles du panier">
            {items.map((item, index) => (
              <div
                key={item.id}
                className={cn('animate-in fade-in slide-in-from-left-4 duration-500', 'opacity-0')}
                style={{

...
export default function DisputeDetail() {
  ...
  const { disputes, loading, createDispute, updateDisputeStatus, addDisputeMessage } =
    useDisputes();
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-medium">
                        {format(new Date(dispute.created_at), 'dd MMM yyyy à HH:mm', {
                          locale: fr,
                        })}
                      </span>
                    </div>
                ...
                <div>
                  ...
                  <p className="text-sm bg-muted p-3 rounded-lg">{dispute.description}</p>
                </div>
                      ...
                      <AlertDescription>
                        ...
                        {dispute.resolved_at && (
                          <p className="text-xs text-green-700 dark:text-green-300 mt-2">
                            Résolu le{' '}
                            {format(new Date(dispute.resolved_at), 'dd MMM yyyy à HH:mm', {
                              locale: fr,
                            })}
                          </p>
                        )}
              ...
              <CardHeader>
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant="secondary">
                    {dispute.messages?.length || 0} message
                    {(dispute.messages?.length || 0) > 1 ? 's' : ''}
                  </Badge>
                </div>
              </CardHeader>
              <CardContent>
                              ...
                              <div className="flex-1">
                                <div className="flex items-center gap-2 mb-1">
                                  ...
                                  <span className="text-xs text-muted-foreground">
                                    {format(new Date(message.created_at), 'dd MMM à HH:mm', {
                                      locale: fr,
                                    })}
                                  </span>
                                </div>
                                ...
                                {message.attachments && message.attachments.length > 0 && (
                                  <div className="mt-2 space-y-2">
                                    {message.attachments.map((url: string, idx: number) => {
                                      ...
                                      const fileName =
                                        urlParts[urlParts.length - 1] || `Pièce jointe ${idx + 1}`;
                    ...
                    <div className="flex gap-2">
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <Button
                          ...
                          disabled={
                            uploadingFiles || (!messageContent.trim() && selectedFiles.length === 0)
                          }
                        >
                          {uploadingFiles ? (
            ...
            <Card className="bg-blue-50 dark:bg-blue-950 border-blue-200">
              ...
              <CardContent>
                <p className="text-sm text-blue-800 dark:text-blue-200">
                  Les litiges sont examinés par notre équipe. Fournissez un maximum de preuves
                  (photos, captures d'écran) pour accélérer la résolution.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <Dialog open={showResolveDialog} onOpenChange={setShowResolveDialog}>
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>Fournir une résolution pour ce litige</DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4">
              ...
              <Alert>
                ...
                <AlertDescription>
                  Cette action marquera le litige comme résolu et notifiera toutes les parties
                  concernées.
                </AlertDescription>
              </Alert>
            </div>

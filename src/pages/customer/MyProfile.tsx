...
const CUSTOMER_ADDRESS_FIELDS =
  'id, user_id, full_name, phone, address_line1, address_line2, city, postal_code, country, state, is_default, created_at';
  ...
  const { data: savedAddresses } = useQuery({
    ...
    queryFn: async (): Promise<ShippingAddress[]> => {
      ...
      const { data, error } = await supabase
        ...
        .select(CUSTOMER_ADDRESS_FIELDS)
        .eq('user_id', user.id)
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                      ...
                      <div className="space-y-2 md:col-span-2">
                        ...
                        <select
                          ...
                          className="flex min-h-[44px] h-11 sm:h-12 w-full rounded-md border border-input bg-background px-3 py-2 text-base touch-manipulation cursor-pointer"
                        >

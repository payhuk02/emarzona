        ...
        <Dialog open={isRegisterDialogOpen} onOpenChange={setIsRegisterDialogOpen}>
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>Enregistrez une garantie pour un produit acheté</DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4 py-4">
              ...
              <div className="flex gap-2">
                ...
                <Button
                  ...
                  disabled={
                    !registerForm.order_id || !registerForm.product_id || registerWarranty.isPending
                  }
                  className="flex-1"
                >

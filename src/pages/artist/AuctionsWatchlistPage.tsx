...
import { Heart, Eye, Clock, Gavel, TrendingUp } from 'lucide-react';
...
export default function AuctionsWatchlistPage() {
  ...
  const endedAuctions =
    watchlist?.filter(
      item => item.auctions?.status === 'ended' || item.auctions?.status === 'sold'
    ) || [];
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              <p className="font-medium">
                                {auction.artist_products?.artwork_title}
                              </p>

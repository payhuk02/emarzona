        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            {product?.artist?.artwork_title && (
              <p className="text-lg text-muted-foreground mb-2">{product.artist.artwork_title}</p>
            )}
            {product?.short_description && (
          ...
          {product?.artist?.requires_shipping && (
            <Suspense fallback={<Skeleton className="h-32 w-full" />}>
              <ArtistShippingCalculator productId={productId!} artworkValue={product?.price || 0} />
            </Suspense>
          )}

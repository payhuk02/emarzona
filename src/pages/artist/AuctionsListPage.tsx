                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex gap-2 pt-2">
                    ...
                    {user && (
                      ...
                      >
                        <Heart
                          className={`h-4 w-4 ${isInWatchlist(auction.id) ? 'fill-current' : ''}`}
                        />
                      </Button>
                    )}
                  </div>
  ...
  return (
    <>
      <SEOMeta
        ...
        description="Participez aux enchères en direct sur Emarzona. Œuvres d'art, pièces rares et éditions limitées proposées par les créateurs."

            ...
            <CardContent className="space-y-4 sm:space-y-6">
              <div className="grid gap-3 sm:gap-4 grid-cols-1 sm:grid-cols-2">
                ...
                <div>
                  ...
                  <p className="font-medium text-sm sm:text-base mt-1">
                    {new Date(submission.date_of_birth).toLocaleDateString('fr-FR')}
                  </p>
                </div>
                <div>
              ...
              {submission.status === 'verified' && (
                <Alert className="bg-green-50 text-green-900 border-green-200 dark:bg-green-900/20 dark:text-green-100 dark:border-green-800">
                  ...
                  <AlertDescription className="text-xs sm:text-sm">
                    Votre identité a été vérifiée avec succès. Vous avez désormais accès à toutes
                    les fonctionnalités.
                  </AlertDescription>
                </Alert>
              )}
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <MobileFormField
                    ...
                    onChange={value =>
                      setFormData({
                        ...formData,
                        document_type: value as KYCFormData['document_type'],
                      })
                    }
                    required
                    selectOptions={[
                  ...
                  <div>
                    <Label htmlFor="document_front" className="text-xs sm:text-sm">
                      Document (recto) * (max 5MB)
                    </Label>
                    <Input
                      id="document_front"
                      type="file"
                  ...
                  <div>
                    <Label htmlFor="document_back" className="text-xs sm:text-sm">
                      Document (verso) (optionnel, max 5MB)
                    </Label>
                    <Input
                      id="document_back"
                      type="file"
                ...
                <Alert className="border-border/50 bg-card/50 backdrop-blur-sm">
                  ...
                  <AlertDescription className="text-xs sm:text-sm">
                    Vos données personnelles sont sécurisées et ne seront utilisées que pour la

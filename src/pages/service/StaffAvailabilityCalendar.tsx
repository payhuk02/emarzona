        ...
        <div className="container mx-auto p-3 sm:p-4 lg:p-6">
          <Card className="animate-in fade-in slide-in-from-top-4">
            <CardContent className="p-12 text-center">
              ...
              <h2 className="text-sm sm:text-base md:text-lg lg:text-xl font-bold mb-1.5 sm:mb-2">
        ...
        <div ref={tabsRef} className="animate-in fade-in slide-in-from-bottom-4 duration-700">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4 sm:space-y-6">
            ...
            <TabsContent value="management" className="space-y-4 sm:space-y-6 mt-4 sm:mt-6">
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 delay-150">
                <StaffAvailabilityManager storeId={store.id} staffMemberId={selectedStaffId} />
              </div>
            </TabsContent>
            ...
            <TabsContent value="settings" className="space-y-4 sm:space-y-6 mt-4 sm:mt-6">
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 delay-150">
                <StaffAvailabilitySettings storeId={store.id} serviceId={serviceId} />
              </div>
            </TabsContent>
          </Tabs>
        </div>

    ...
    >
      <div className="space-y-2">
        ...
        <Select
          ...
          onValueChange={value => setFormData({ ...formData, calendar_type: value as string })}
        >
          <SelectTrigger>
            <SelectValue />
          </SelectTrigger>
      ...
      <div className="space-y-2">
        ...
        <Select
          ...
          onValueChange={value =>
            setFormData({
              ...formData,
              sync_direction: value as 'bidirectional' | 'to_calendar' | 'from_calendar',
            })
          }
        >
          <SelectTrigger>
      ...
      <div className="flex items-center justify-between">
        ...
        <Switch
          ...
          onCheckedChange={checked =>
            setFormData({ ...formData, create_events_for_bookings: checked })
          }
        />
      </div>
    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="space-y-2">
        ...
        <Input
          ...
          onChange={e =>
            setFormData({ ...formData, sync_interval_minutes: parseInt(e.target.value) })
          }
          min={1}
        />
      </div>

              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs sm:text-sm text-muted-foreground mb-1">
                    {t('pixels.stats.total', 'Total Pixels')}
                  </p>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">
                    {t('pixels.stats.active', {
                      count: activePixels,
                      defaultValue: `${activePixels} actif${activePixels > 1 ? 's' : ''}`,
                    })}
                  </p>
                </div>
          ...
          <Card className="border-border/50 bg-card/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300 hover:scale-[1.02]">
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs sm:text-sm text-muted-foreground mb-1">
                    {t('pixels.stats.addToCart', 'Add to Cart')}
                  </p>
          ...
          <Card className="border-border/50 bg-card/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300 hover:scale-[1.02]">
            <CardContent className="p-3 sm:p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs sm:text-sm text-muted-foreground mb-1">
                    {t('pixels.stats.purchases', 'Achats')}
                  </p>
        ...
        >
          <CardHeader>
            <CardTitle className="text-base sm:text-lg">
              {t('pixels.list.title', 'Vos Pixels')}
            </CardTitle>
            <CardDescription className="text-xs sm:text-sm">
              {t(
                'pixels.list.description',
          ...
          <CardContent className="space-y-3 sm:space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Cliquez sur "Ajouter un Pixel" et renseignez les informations de votre Pixel
                  publicitaire (Facebook, Google, TikTok, etc.).
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Vos Pixels actifs seront automatiquement injectés sur vos pages de produits et de
                  vente.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Le système envoie automatiquement les événements importants : visites de pages,
                  ajouts au panier, achats et leads.
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Vos Pixels sont privés et ne s'activent que sur vos propres produits. Conformité
                  RGPD garantie.
                </p>
              </div>
            </div>

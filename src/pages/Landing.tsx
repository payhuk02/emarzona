...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <header
        className="sticky top-0 z-50 border-b border-border/50 bg-card/80 backdrop-blur-xl shadow-lg"
        role="banner"
      >
        ...
        {mobileMenuOpen && (
          <nav
            className="lg:hidden border-t bg-card/98 backdrop-blur-sm animate-fade-in-up"
        ...
        <div className="gradient-hero relative overflow-hidden w-full py-16 sm:py-20 md:py-28 lg:py-36 xl:py-44">
          ...
          <div className="w-full max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 xl:px-12 2xl:px-16 relative z-10">
            <div className="max-w-5xl mx-auto text-center animate-fade-in-up">
              {/* Badge Premium */}
              <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md px-3 sm:px-4 md:px-5 lg:px-6 py-1.5 sm:py-2 md:py-2.5 rounded-full mb-5 sm:mb-6 md:mb-8 lg:mb-10 border border-white/20 shadow-lg hover:bg-white/15 transition-all duration-300">
                <Rocket className="h-3.5 w-3.5 sm:h-4 sm:w-4 md:h-5 md:w-5 text-white flex-shrink-0" />
                <span className="text-xs xs:text-sm sm:text-base md:text-lg text-white font-bold tracking-wide whitespace-nowrap">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-5 justify-center items-stretch sm:items-center mb-10 sm:mb-12 md:mb-16 px-3 sm:px-4">
                <Link to="/auth" className="w-full sm:w-auto group flex-shrink-0">
                  <Button
                    size="lg"
                    className="w-full sm:w-auto bg-white text-gray-900 font-bold text-base sm:text-lg px-6 sm:px-8 md:px-10 py-4 sm:py-5 md:py-6 rounded-xl shadow-2xl hover:bg-gray-50 hover:shadow-[0_20px_50px_rgba(0,0,0,0.3)] hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 ease-out whitespace-nowrap border-0 relative overflow-hidden group"
                  >
                ...
                <Link to="/marketplace" className="w-full sm:w-auto flex-shrink-0">
                  <Button
                    size="lg"
                    variant="outline"
                    className="w-full sm:w-auto bg-white/95 backdrop-blur-md text-gray-900 text-base sm:text-lg px-6 sm:px-8 md:px-10 py-4 sm:py-5 md:py-6 rounded-xl border-2 border-white/60 hover:bg-white hover:border-white hover:shadow-[0_20px_50px_rgba(255,255,255,0.3)] hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 ease-out font-bold whitespace-nowrap relative overflow-hidden group"
                  >
                    <span className="relative z-10 flex items-center justify-center">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-5 md:gap-6 lg:gap-8 max-w-6xl mx-auto mb-8 sm:mb-10 md:mb-12 px-4">
                <div className="group bg-white/95 backdrop-blur-md rounded-2xl p-5 sm:p-6 md:p-8 lg:p-10 border border-white/50 shadow-lg hover:shadow-2xl hover:-translate-y-1 active:translate-y-0 transition-all duration-300 ease-out hover:bg-white overflow-hidden relative">
                  ...
                  <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-2 break-words relative z-10">
                    {animatedStats.users.toLocaleString()}+
                  </div>
                  <div className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-700 font-bold leading-tight relative z-10">
                    Vendeurs actifs
                  </div>
                </div>
                <div className="group bg-white/95 backdrop-blur-md rounded-2xl p-5 sm:p-6 md:p-8 lg:p-10 border border-white/50 shadow-lg hover:shadow-2xl hover:-translate-y-1 active:translate-y-0 transition-all duration-300 ease-out hover:bg-white overflow-hidden relative">
                  ...
                  <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold bg-gradient-to-r from-orange-500 to-amber-500 bg-clip-text text-transparent mb-2 break-words relative z-10">
                ...
                <div className="group bg-white/95 backdrop-blur-md rounded-2xl p-5 sm:p-6 md:p-8 lg:p-10 border border-white/50 shadow-lg hover:shadow-2xl hover:-translate-y-1 active:translate-y-0 transition-all duration-300 ease-out hover:bg-white overflow-hidden relative">
                  ...
                  <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent mb-2 break-words relative z-10">
                ...
                <div className="group bg-white/95 backdrop-blur-md rounded-2xl p-5 sm:p-6 md:p-8 lg:p-10 border border-white/50 shadow-lg hover:shadow-2xl hover:-translate-y-1 active:translate-y-0 transition-all duration-300 ease-out hover:bg-white overflow-hidden relative">
                  ...
                  <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent mb-2 break-words relative z-10">
      ...
      <section className="py-12 sm:py-16 md:py-20 lg:py-24 bg-background">
        <div className="container mx-auto px-3 sm:px-4 md:px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 lg:gap-12 max-w-7xl mx-auto">
            {/* Affiliation */}
            <Card className="bg-card/95 backdrop-blur-md border border-border/60 shadow-md hover:shadow-2xl hover:border-accent/30 hover:-translate-y-1 active:translate-y-0 transition-all duration-300 ease-out group overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-br from-accent/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                  ...
                  >
                    <Card className="bg-card/95 backdrop-blur-md border border-border/60 shadow-md hover:shadow-2xl hover:border-primary/30 hover:-translate-y-1 active:translate-y-0 transition-all duration-300 ease-out h-full overflow-hidden group">
                      ...
                      <CardContent className="p-5 sm:p-6 md:p-8 relative z-10">
                        <div className="flex items-center gap-1 sm:gap-1.5 mb-4 sm:mb-5 md:mb-6">
                          {[...Array(5)].map((_, i) => (
                            <Star
                              key={i}
                              className="h-4 w-4 sm:h-5 sm:w-5 md:h-6 md:w-6 text-accent group-hover:scale-110 transition-transform duration-300"
                              fill="currentColor"
                              style={{ transitionDelay: `${i * 50}ms` }}
                            />
                          ))}
                        </div>
                        <p className="text-foreground mb-4 sm:mb-6 leading-relaxed text-sm sm:text-base md:text-lg font-normal">
                          "{testimonial.content}"
                        </p>
                        <div className="flex items-center gap-3 sm:gap-4 pt-4 border-t border-border/50">
                          <OptimizedImg
                            ...
                            width={56}
                            height={56}
                            className="h-12 w-12 sm:h-14 sm:w-14 rounded-full object-cover ring-2 ring-primary/20 group-hover:ring-primary/40 flex-shrink-0 transition-all duration-300"
                            style={{ aspectRatio: '1/1' }}
                            priority={index === 0}
                            decoding="async"
                          />
                          <div>
                            <p className="font-bold text-sm sm:text-base md:text-lg text-foreground">
                              {testimonial.name}
                            </p>

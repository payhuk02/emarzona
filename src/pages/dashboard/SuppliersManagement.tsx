          ...
          <div className="container mx-auto p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
            ...
            >
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-lg sm:text-2xl font-bold text-yellow-600">{stats.preferred}</div>
                </CardContent>
              </Card>
            ...
            <Tabs value={selectedTab} onValueChange={(v) => setSelectedTab(v as any)}>
              ...
              <CardHeader>
                ...
                <CardDescription>{filteredSuppliers.length} fournisseur{filteredSuppliers.length > 1 ? 's' : ''} trouvé{filteredSuppliers.length > 1 ? 's' : ''}</CardDescription>
              </CardHeader>
              <CardContent>
                      ...
                      <TableBody>
                        {filteredSuppliers.map((supplier) => (
                          <TableRow key={supplier.id}>
                            ...
                            <TableCell>
                              {supplier.total_spent.toLocaleString('fr-FR')} {supplier.currency}
                            </TableCell>
                            <TableCell>
                ...
                <div className="space-y-4 py-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      disabled={!supplierForm.name || createSupplier.isPending || updateSupplier.isPending}
                      className="flex-1"
                    >

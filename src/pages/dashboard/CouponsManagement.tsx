...
const PROMOTION_USAGE_FIELDS =
  'id, promotion_id, order_id, customer_id, discount_amount, order_total_before, order_total_after, customer_email, customer_name, used_at';

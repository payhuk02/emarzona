...
export default function LiveSessionsManagement() {
  ...
  const { data: sessions = [], isLoading: sessionsLoading } =
    useCourseLiveSessions(selectedCourseId);
  ...
  const [statusFilter, setStatusFilter] = useState<
    'all' | 'scheduled' | 'live' | 'ended' | 'cancelled'
  >('all');
  const [platformFilter, setPlatformFilter] = useState<'all' | 'zoom' | 'google_meet' | 'native'>(
    'all'
  );
    ...
    if (session) {
      setFormData({
        ...
        scheduled_start: session.scheduled_start
          ? new Date(session.scheduled_start).toISOString().slice(0, 16)
          : '',
        scheduled_end: session.scheduled_end
          ? new Date(session.scheduled_end).toISOString().slice(0, 16)
          : '',
                          ...
                          <TableRow key={session.id}>
                            ...
                            <TableCell>
                              <div className="text-sm">
                                <div>
                                  {format(new Date(session.scheduled_start), 'dd MMM yyyy', {
                                    locale: fr,
                                  })}
                                </div>
                                <div className="text-muted-foreground">
                                  ...
                                  -{' '}
                                  {format(new Date(session.scheduled_end), 'HH:mm', { locale: fr })}
                                </div>
                              </div>
                            </TableCell>
                              ...
                              <Select>
                                ...
                                <SelectContent mobileVariant="sheet" className="min-w-[200px]">
                                  {session.meeting_url && (
                                    <SelectItem
                                      value="edit"
                                      onSelect={() => window.open(session.meeting_url, '_blank')}
                                    >
                                  ...
                                  <SelectItem
                                    value="delete"
                                    onSelect={() => handleEditSession(session.id)}
                                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={v => setFormData({ ...formData, session_type: v as string })}
                  >
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={v => setFormData({ ...formData, platform: v as string })}
                  >
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={checked =>
                      setFormData({ ...formData, recording_enabled: checked as boolean })
                    }
                  />
                  <Label htmlFor="recording_enabled" className="cursor-pointer">
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={checked =>
                      setFormData({ ...formData, allow_questions: checked as boolean })
                    }
                  />
                  <Label htmlFor="allow_questions" className="cursor-pointer">
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={checked =>
                      setFormData({ ...formData, allow_chat: checked as boolean })
                    }
                  />
                  <Label htmlFor="allow_chat" className="cursor-pointer">
                    Autoriser le chat
                  </Label>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={checked =>
                      setFormData({ ...formData, require_registration: checked as boolean })
                    }
                  />
                  <Label htmlFor="require_registration" className="cursor-pointer">
                    Inscription requise
                  </Label>
                </div>
              </div>

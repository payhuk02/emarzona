...
export default function ReviewsManagement() {
  ...
  const [productTypeFilter, setProductTypeFilter] = useState<'all' | 'digital' | 'physical' | 'service' | 'course'>('all');
      ...
      <div className="flex min-h-screen w-full bg-background">
        ...
        <main className="flex-1 overflow-auto">
          <div className="container mx-auto p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  {stats.averageRating > 0 && (
                    <ReviewStars rating={Math.round(stats.averageRating)} size="sm" className="mt-1" />
                  )}
                </CardContent>
              </Card>
                ...
                {filteredReviews.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-muted-foreground">
                      {searchQuery || statusFilter !== 'all' || ratingFilter !== 'all' || productTypeFilter !== 'all'
                            ...
                            <div className="flex-1 space-y-3">
                              ...
                              <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                  <div className="flex items-center gap-2 mb-1">
                                    <h4 className="font-semibold">{review.product?.name || 'Produit'}</h4>
                              ...
                              <div className="flex items-center gap-4 text-xs text-muted-foreground">
                                ...
                                <div className="flex items-center gap-1">
                                  ...
                                  <span>{review.reply_count} réponse{review.reply_count > 1 ? 's' : ''}</span>
                                </div>
                              </div>
                            </div>
                            ...
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                ...
                                >
                                  ...
                                  {review.is_featured ? 'Retirer de la vedette' : 'Mettre en vedette'}
                                </DropdownMenuItem>
                                <DropdownMenuItem
            ...
            <Dialog open={!!viewingReviewId} onOpenChange={(open) => !open && setViewingReviewId(null)}>
              <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
                ...
                {viewingReviewId && (() => {
                  ...
                  return <ReviewCard review={review as any} showReplies />;
                })()}
              </DialogContent>
            </Dialog>

            {/* Dialog Réponse */}
            <Dialog open={!!replyingToReviewId} onOpenChange={(open) => !open && setReplyingToReviewId(null)}>

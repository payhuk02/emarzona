        ...
        >
          <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>Gérez les soumissions et notez les assignments</DialogDescription>
            </DialogHeader>
            <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <CardDescription>
                              ...
                              {submission.submitted_at
                                ? format(new Date(submission.submitted_at), 'dd MMM yyyy à HH:mm', {
                                    locale: fr,
                                  })
                                : 'N/A'}
                              {submission.is_late && (
        ...
        >
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Cette action est irréversible. L'assignment sera définitivement supprimé ainsi que

      ...
      <div className="container mx-auto p-4 md:p-6 space-y-6">
        ...
        >
          <div>
            ...
            <p className="text-muted-foreground mt-1">Gérez vos portfolios et galeries d'œuvres</p>
          </div>
          <Button
              ...
              <Card key={portfolio.id} className="hover:shadow-lg transition-shadow">
                ...
                <CardContent>
                  ...
                  <div className="flex items-center gap-4 text-sm text-muted-foreground mb-4">
                    ...
                    <div>{portfolio.total_artworks} œuvres</div>
                  </div>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Cette action est irréversible. Toutes les galeries et œuvres associées seront

...
const ABANDONED_CART_FIELDS =
  'id, user_id, session_id, customer_email, cart_items, total_amount, currency, recovery_attempts, reminder_sent_at, recovered_at, created_at, updated_at';
        ...
        <Dialog open={!!viewingCartId} onOpenChange={open => !open && setViewingCartId(null)}>
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>Informations complètes sur ce panier abandonné</DialogDescription>
            </DialogHeader>
            {viewingCartId && (

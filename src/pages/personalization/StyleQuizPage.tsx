          ...
          <div className="container mx-auto px-4 py-8">
            ...
            <div className="text-center mb-8">
              ...
              {styleProfile && (
                <div className="space-y-4">
                  <h1 className="text-3xl font-bold">Style {getStyleDescription(styleProfile)}</h1>
            ...
            <div className="space-y-6">
              ...
              <div className="text-center">
                <Button size="lg" onClick={handleStartShopping} className="px-8 py-3">
      ...
      <div className="bg-gradient-to-br from-background via-background to-accent/10 py-8">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold mb-4">Découvrez Votre Style Unique</h1>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Répondez à quelques questions et laissez-nous vous guider vers les produits parfaits
              pour votre style personnel.
            </p>
          </div>

          {/* Quiz */}
          <StyleQuiz onComplete={handleQuizComplete} onSkip={handleSkipQuiz} />

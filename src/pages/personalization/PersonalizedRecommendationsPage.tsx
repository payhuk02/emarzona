...
const PersonalizedRecommendationsPage: React.FC = () => {
  ...
  const stats = useMemo(() => {
    if (!recommendations)
      return { total: 0, digital: 0, physical: 0, service: 0, course: 0, artist: 0 };
  ...
  return (
    <AppPageShell>
      <div className="container mx-auto p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
              ...
              >
                <CardContent className="p-3 sm:p-4 lg:p-6">
                  <div className="flex items-center justify-between">
                    ...
                    <div
                      className={`p-1.5 sm:p-2 rounded-lg bg-gradient-to-br ${stat.color} shadow-lg`}
                    >
        ...
        <div
          ref={filtersRef}
          className="flex flex-col sm:flex-row gap-3 sm:gap-4 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-300"
        >
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full sm:w-auto">
            <TabsList className="grid w-full grid-cols-3 sm:grid-cols-6 h-9 sm:h-10">
              ...
              <TabsTrigger value="digital" className="text-xs sm:text-sm">
                Digital
              </TabsTrigger>
              ...
              >
                ...
                <CardContent className="p-4">
                  <div className="space-y-2">
                    ...
                    {product.store?.name && (
                      <p className="text-xs text-muted-foreground">Par {product.store.name}</p>
                    )}
                    <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {product.promotional_price &&
                        product.promotional_price < (product.price || 0) && (

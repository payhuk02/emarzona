          ...
          <div className="container mx-auto p-3 sm:p-4 md:p-6 space-y-3 sm:space-y-4 md:space-y-6">
            ...
            >
              <TabsList className="grid w-full grid-cols-3 text-[10px] sm:text-xs md:text-sm">
                ...
                <TabsTrigger value="payments" className="text-[10px] sm:text-xs md:text-sm">
                  Paiements ({filteredPayments.length})
                </TabsTrigger>
                <TabsTrigger value="customers" className="text-[10px] sm:text-xs md:text-sm">
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] sm:text-xs md:text-sm">
                          {selectedPayment.customers?.name || 'N/A'}
                        </p>

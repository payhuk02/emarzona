      ...
      <div className="max-w-7xl mx-auto space-y-6">
          ...
          <Card>
            <CardContent className="pt-6">
              <div className="text-2xl font-bold">
                {returns?.filter(r => (r as ReturnWithRelations).status === 'requested').length ||
                  0}
              </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Gérez toutes les demandes de retour de vos produits</CardDescription>
          </CardHeader>
          <CardContent>
              ...
              {refundMethod === 'original_payment' && (
                <div className="space-y-2">
                  {pspPreviewLoading ? (
                    ...
                    <Alert>
                      <AlertDescription>
                        Remboursement via <strong>{pspRefundPreview.providerLabel}</strong> (max.{' '}
                        {pspRefundPreview.maxAmount.toLocaleString()} {pspRefundPreview.currency}).
                      </AlertDescription>
                    </Alert>
                  ) : (
                    <Alert variant="destructive">
                      <AlertDescription>
                        Aucune transaction payée trouvée pour cette commande. Choisissez un autre
              ...
              <div className="flex justify-end gap-2 pt-4">
                ...
                <Button
                  ...
                  disabled={
                    ...
                    (refundMethod === 'original_payment' && !pspPreviewLoading && !pspRefundPreview)
                  }
                >

...
export default function AdminCommunity() {
  ...
  const [memberStatusFilter, setMemberStatusFilter] = useState<CommunityMemberStatus | 'all'>(
    'all'
  );
      ...
      <div className="container mx-auto p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
          ...
          <div>
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold flex items-center gap-2 mb-1 sm:mb-2">
              <div className="p-2 rounded-lg bg-gradient-to-br from-blue-500/10 to-purple-500/5 backdrop-blur-sm border border-blue-500/20">
                <Users
                  className="h-5 w-5 sm:h-6 sm:w-6 lg:h-8 lg:w-8 text-blue-500 dark:text-blue-400"
                  aria-hidden="true"
                />
              </div>
        ...
        <Tabs value={activeTab} onValueChange={v => setActiveTab(v as typeof activeTab)}>
          <TabsList className="grid w-full grid-cols-3">
            ...
            <TabsTrigger value="members" className="min-h-[44px]">
              Membres
            </TabsTrigger>
              ...
              <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      ...
                      <p className="text-xs text-muted-foreground">Demandes d'adhésion</p>
                    </CardContent>
                  </Card>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <Card>
                    ...
                    <CardContent>
                      {statistics?.members_by_country &&
                      statistics.members_by_country.length > 0 ? (
                  ...
                  <Card>
                    ...
                    <CardContent>
                      {statistics?.members_by_profession &&
                      statistics.members_by_profession.length > 0 ? (
                        <div className="space-y-2">
              ...
              <CardHeader>
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  <div>
                    ...
                    <CardDescription>Gérez les membres et leurs statuts</CardDescription>
                  </div>
                        ...
                        },
                        {
                          ...
                          render: (row: CommunityMember) => (
                            <span className="text-xs text-muted-foreground">
                              {formatDistanceToNow(new Date(row.join_date || row.created_at), {
                                addSuffix: true,
                                locale: fr,
                              })}
                            </span>
                                    ...
                                    <SelectContent mobileVariant="sheet" className="min-w-[200px]">
                                      {member.status === 'pending' && (
                                        <SelectItem
                                          value="edit"
                                          onSelect={() =>
                                            handleMemberStatusChange(member.id, 'approved')
                                          }
                                        >
                                          <CheckCircle className="h-4 w-4 mr-2" />
                                          Approuver
                                      ...
                                      {member.status === 'approved' && (
                                        <SelectItem
                                          value="delete"
                                          onSelect={() =>
                                            handleMemberStatusChange(member.id, 'suspended')
                                          }
                                        >
                                          <Ban className="h-4 w-4 mr-2" />
                                          Suspendre
              ...
              <CardHeader>
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  <div>
                    ...
                    <CardDescription>Gérez les publications de la communauté</CardDescription>
                  </div>
                  <Button
                    onClick={() => {
        ...
        <AlertDialog open={deleteMemberDialogOpen} onOpenChange={setDeleteMemberDialogOpen}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Êtes-vous sûr de vouloir supprimer ce membre de la communauté ? Cette action est
                irréversible.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>

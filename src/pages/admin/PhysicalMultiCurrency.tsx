          ...
          <div className="container mx-auto p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
            ...
            <div ref={tabsRef} className="animate-in fade-in slide-in-from-bottom-4 duration-700">
              <Tabs defaultValue="manager" className="space-y-4 sm:space-y-6">
                ...
                <TabsContent value="manager" className="space-y-4 sm:space-y-6 mt-3 sm:mt-4 lg:mt-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
                  <CurrencyManager />
                </TabsContent>

                <TabsContent value="converter" className="space-y-4 sm:space-y-6 mt-3 sm:mt-4 lg:mt-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
                  <CurrencyConverter />
                </TabsContent>
              </Tabs>
            </div>

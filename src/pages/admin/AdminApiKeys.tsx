/**
 * Admin — Vue plateforme des clés API publiques (pagination serveur)
 */
...
import { useAdminApiKeysList } from '@/hooks/useAdminApiKeys';
...
export default function AdminApiKeys() {
  ...
  const [pageSize, setPageSize] = useState(DEFAULT_ADMIN_API_KEY_PAGE_SIZE);
      ...
      <div className="container mx-auto p-3 sm:p-6 space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              {totalCount} clé(s) au total — révoquez une clé compromise sans supprimer
              l&apos;historique.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="relative max-w-md">
              ...
              <Input
                className="pl-9"
                placeholder="Rechercher boutique, nom, préfixe (min. 2 car.)…"
                value={searchInput}
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      >
                        ...
                        <SelectContent>
                          {ADMIN_API_KEY_PAGE_SIZES.map(size => (

          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Select
                  value={statusFilter}
                  onValueChange={(value: 'all' | 'exists' | 'missing') => setStatusFilter(value)}
                >
        ...
        <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Vous êtes sur le point de supprimer {missingFiles.length} entrée(s) de la base de
                données pour les fichiers qui n'existent pas dans le bucket.
                <br />
                <br />

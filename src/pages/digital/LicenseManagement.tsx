  ...
  return (
    <AppPageShell mainClassName="overflow-x-hidden">
      <div className="container mx-auto p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Licenses actives</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Toutes licenses</p>
            </CardContent>
          </Card>
        </div>
        ...
        {/* License Table */}
        <LicenseTable searchQuery={searchQuery} statusFilter={statusFilter} />
        ...
        <Dialog open={showGenerator} onOpenChange={setShowGenerator}>
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>Créez des licenses pour vos produits digitaux</DialogDescription>
            </DialogHeader>
            <LicenseGenerator
              onSuccess={() => {

...
export default function DigitalProductUpdatesDashboard() {
  ...
  const selectedProduct = selectedProductId
    ? digitalProducts.find(
        (p: DigitalProductWithId) =>
          p.id === selectedProductId || p.product_id === selectedProductId
      )
    : null;
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4">
          ...
          {selectedProduct && (
            <Button
              ...
              className="gap-1.5 sm:gap-2 min-h-[44px] text-xs sm:text-sm w-full sm:w-auto"
            >
        ...
        {!selectedProductId && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>{t('digitalUpdates.selectProductDesc')}</CardDescription>
            </CardHeader>
            <CardContent>
              {digitalProducts.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <h3 className="text-base sm:text-lg font-semibold mb-2">
                    {t('digitalUpdates.noProducts')}
                  </h3>
                  <p className="text-muted-foreground mb-4">{t('digitalUpdates.noProductsDesc')}</p>
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            <div className="flex-1">
                              <h3 className="font-semibold">
                                {product.product?.name || t('digitalUpdates.productWithoutName')}
                              </h3>
                              <p className="text-sm text-muted-foreground">
                                {t('digitalUpdates.currentVersion', {
                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <Button variant="outline" onClick={() => setSelectedProductId(undefined)}>
                        Changer de produit
                      </Button>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge
                        variant={selectedProduct.update_notifications ? 'default' : 'secondary'}
                      >

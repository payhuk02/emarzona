        ...
        <div className="container mx-auto p-4 md:p-6">
          <Card>
            <CardContent className="py-12 text-center">
              ...
              <Button onClick={() => navigate('/dashboard/products')}>Retour aux produits</Button>
            </CardContent>
          </Card>
        </div>
      </AppPageShell>
      ...
      <div className="container mx-auto p-4 md:p-6 space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Toutes les versions publiées de ce produit</CardDescription>
          </CardHeader>
          <CardContent>
                      ...
                      <TableCell>
                        <div>
                          <div className="font-semibold flex items-center gap-2">
                            ...
                            {version.is_current && <Badge variant="default">Actuelle</Badge>}
                          ...
                          {version.version_name && (
                            <p className="text-sm text-muted-foreground">{version.version_name}</p>
                          )}
                        </div>
                      </TableCell>
                      <TableCell>

  ...
  return (
    <>
      <SEOMeta
        ...
        description="Politique des cookies Emarzona : types de cookies utilisés, finalités, durée de conservation et gestion des préférences."
        url="https://www.emarzona.com/legal/cookies"
        canonical="https://www.emarzona.com/legal/cookies"
        type="article"
      />
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 mt-1">
                  ...
                  {cookieDoc?.effective_date
                    ? new Date(cookieDoc.effective_date).toLocaleDateString('fr-FR')
                    : '27 octobre 2025'}{' '}
            ...
            <LegalDocumentContent
              ...
              fallback={
                <>
                  {/* Introduction */}
                  <p className="lead">
                    Cette politique explique ce que sont les cookies, comment nous les utilisons sur
                    Emarzona, et comment vous pouvez contrôler vos préférences.
                  </p>
                  ...
                  <p>
                    ...
                    au site de mémoriser vos actions et préférences sur une période donnée.
                  </p>
                  ...
                  <p>
                    ...
                    désactivés. Ils permettent la navigation de base et l'accès aux zones
                    sécurisées.
                  </p>
                  ...
                  <p>
                    Lors de votre première visite, un banner apparaît en bas de la page. Vous pouvez
                    :
                  </p>
                  <ul>
                    <li>
                      <strong>Tout accepter :</strong> tous les cookies sont activés
                    </li>
                    <li>
                      <strong>Tout refuser :</strong> seuls les cookies nécessaires restent actifs
                    </li>
                    <li>
                      <strong>Personnaliser :</strong> choisir catégorie par catégorie
                    </li>
                  </ul>
                  ...
                  <ul>
                    ...
                    <li>
                      <strong>Facebook Pixel :</strong> remarketing publicitaire
                    </li>
                    <li>
                      <strong>TikTok Pixel :</strong> mesure campagnes publicitaires
                    </li>
                    <li>
                      <strong>Crisp Chat :</strong> support client en ligne
                    </li>
                  </ul>
                  <p>
                    Ces sociétés ont leurs propres politiques de confidentialité. Nous vous
                  ...
                  <ul>
                    ...
                    <li>
                      <strong>Cookies persistants :</strong> conservés selon la durée indiquée (max
                      13 mois pour analytics)
                    </li>
                  </ul>
                  ...
                  <p>
                    Nous pouvons modifier cette politique cookies pour refléter des changements dans
                    nos pratiques. La version mise à jour sera toujours disponible sur cette page

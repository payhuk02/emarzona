  ...
  return (
    <>
      <SEOMeta
        ...
        description="Conditions générales d'utilisation de la plateforme Emarzona. Règles, droits et obligations des utilisateurs vendeurs et acheteurs."
        url="https://www.emarzona.com/legal/terms"
        canonical="https://www.emarzona.com/legal/terms"
        type="article"
      />
          ...
          <div className="container mx-auto px-4 py-4 max-w-4xl">
            ...
            <p className="text-sm text-gray-600 mt-2">
              ...
              {termsDoc?.effective_date
                ? new Date(termsDoc.effective_date).toLocaleDateString('fr-FR')
                : '27 octobre 2025'}{' '}
              ...
              fallback={
                <>
                  ...
                  <p>
                    ...
                    d'être lié par les présentes Conditions Générales d'Utilisation ("CGU"). Si vous
                  ...
                  <p>
                    Emarzona est une plateforme e-commerce et e-learning permettant aux utilisateurs
                    de :
                  </p>
                  <ul>
                  ...
                  <p>
                    Pour utiliser certaines fonctionnalités de la Plateforme, vous devez créer un
                  ...
                  <p>
                    ...
                    le droit d'auteur et appartient à Emarzona ou à ses concédants de licence. Vous
                    conservez les droits sur le contenu que vous créez et publiez.
                  </p>

                  {/* 6. Paiements et remboursements */}
                  <h2>6. Paiements et remboursements</h2>
                  <p>
                    Les paiements sont traités de manière sécurisée via Moneroo. Les remboursements
                    sont soumis à notre Politique de Remboursement. Consultez notre page dédiée pour
                    plus d'informations.
                  </p>
                  ...
                  <h2>7. Résiliation</h2>
                  <p>
                    Nous nous réservons le droit de suspendre ou de résilier votre compte à tout
                    moment, avec ou sans préavis, en cas de violation des présentes CGU. Vous pouvez
                    également résilier votre compte à tout moment depuis vos paramètres.
                  </p>

                  {/* 8. Limitation de responsabilité */}
                  <h2>8. Limitation de responsabilité</h2>
                  <p>
                    La Plateforme est fournie "en l'état". Nous ne garantissons pas que le service
                    sera ininterrompu, sécurisé ou exempt d'erreurs. Dans la mesure permise par la
                  ...
                  <p>
                    ...
                    modifications prendront effet dès leur publication sur la Plateforme. Votre
                    utilisation continue constitue votre acceptation des modifications.
                  </p>

                  {/* 10. Droit applicable */}
                  <h2>10. Droit applicable</h2>
                  <p>
                    Ces CGU sont régies par le droit applicable dans votre juridiction. Tout litige
                    sera soumis à la compétence exclusive des tribunaux compétents.
                  </p>
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mt-8">
                    ...
                    <p className="text-sm text-yellow-700">
                      Ce document est un template générique. Il doit être adapté à votre situation
                      spécifique et validé par un avocat spécialisé avant utilisation en production.
                    </p>
                  </div>
                </>
              }

    ...
    <div className="container mx-auto py-4 sm:py-6 lg:py-8 space-y-4 sm:space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm sm:text-base text-muted-foreground mt-1">
              {t('promotions.description', 'Créez et gérez toutes vos promotions et codes de réduction')}
            </p>
          </div>
        </div>
      </div>
      ...
      <Alert className="border-blue-200 bg-blue-50/50 dark:bg-blue-950/20">
        ...
        <AlertDescription className="text-blue-800 dark:text-blue-200">
          Toutes vos promotions sont maintenant gérées dans un système unifié. 
          Vous pouvez créer des promotions pour tous les types de produits (physiques, digitaux, services, cours) 
          ...
          <div className="grid gap-4 md:grid-cols-2">
            <div className="space-y-2">
              ...
              <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
                <li><strong>Pourcentage:</strong> Réduction en % sur le total</li>
                <li><strong>Montant fixe:</strong> Réduction d'un montant précis</li>
                <li><strong>Livraison gratuite:</strong> Offre la livraison gratuite</li>
                <li><strong>Acheter X obtenir Y:</strong> Promotion conditionnelle</li>
              </ul>
            </div>
            <div className="space-y-2">
              <h3 className="font-semibold text-sm">Portée de la promotion</h3>
              <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
                <li><strong>Tous les produits:</strong> S'applique à tous vos produits</li>
                <li><strong>Produits spécifiques:</strong> Sélectionnez des produits précis</li>
                <li><strong>Catégories:</strong> Par catégorie de produits</li>
                <li><strong>Collections:</strong> Par collection de produits</li>
              </ul>
            </div>
          </div>
        </CardContent>

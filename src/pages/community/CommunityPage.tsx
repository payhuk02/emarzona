  ...
  const handleJoinClick = () => {
    ...
    if (isMember) {
      ...
      toast({
        ...
        description:
          "Votre demande d'adhésion est en cours de traitement. Vous serez notifié une fois approuvé.",
      });
    } else {
  ...
  return (
    <>
      <SEOMeta
        ...
        description="Rejoignez la communauté Emarzona : échangez avec d'autres créateurs et acheteurs, partagez vos expériences et découvrez des conseils."
      ...
      <AppPageShell>
        <div className="container mx-auto space-y-4 sm:space-y-6">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  {!user ? (
                    ...
                    <Button onClick={handleJoinClick} className="w-full sm:w-auto min-h-[44px]">
                      ...
                      <span className="sm:hidden">{isPending ? 'En attente' : 'Rejoindre'}</span>
                    </Button>
                  )}
                </div>
              </div>
          ...
          {/* Main Content */}
          <div className="px-0 sm:px-0 lg:px-0 py-2 sm:py-4">
                ...
                <CardContent className="pt-4 sm:pt-6">
                  <div className="flex items-start sm:items-center gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs sm:text-sm text-muted-foreground">
                        Votre demande d'adhésion est en cours de traitement. Vous recevrez une
                        notification une fois approuvé.
                      </p>
                    </div>
                  </div>
                </CardContent>
              ...
              <CommunityMemberForm
                onSuccess={() => {
                  ...
                  toast({
                    ...
                    description:
                      "Votre demande d'adhésion a été envoyée. Vous serez notifié une fois approuvé.",
                  });
                }}
              />
            </DialogContent>
          ...
          <Dialog open={postFormOpen} onOpenChange={setPostFormOpen}>
            <DialogContent className="max-w-full sm:max-w-4xl max-h-[90vh] overflow-y-auto p-3 sm:p-6">
              <DialogHeader>
                ...
                <DialogDescription>Partagez quelque chose avec la communauté</DialogDescription>
              </DialogHeader>
              <CommunityPostForm
                onSuccess={() => {

...
export const Marketing = () => {
  ...
  return (
    <AppPageShell layoutType="marketing">
                ...
                >
                  <CardHeader className="pb-2 sm:pb-3 p-3 sm:p-4 md:p-6">
                    <div className="flex items-center gap-2 sm:gap-2.5 md:gap-3 mb-1.5 sm:mb-2">
                      <div
                        className={`p-1.5 sm:p-2 rounded-lg bg-gradient-to-br ${feature.color === 'from-purple-600 to-pink-600' ? 'from-purple-500/10 to-pink-500/10' : feature.color === 'from-blue-600 to-cyan-600' ? 'from-blue-500/10 to-cyan-500/10' : feature.color === 'from-green-600 to-emerald-600' ? 'from-green-500/10 to-emerald-500/10' : feature.color === 'from-orange-600 to-amber-600' ? 'from-orange-500/10 to-amber-500/10' : 'from-indigo-500/10 to-purple-500/10'}`}
                      >
                        <Icon
                          className={`h-3.5 w-3.5 sm:h-4 sm:w-4 md:h-5 md:w-5 ${feature.color === 'from-purple-600 to-pink-600' ? 'text-purple-500' : feature.color === 'from-blue-600 to-cyan-600' ? 'text-blue-500' : feature.color === 'from-green-600 to-emerald-600' ? 'text-green-500' : feature.color === 'from-orange-600 to-amber-600' ? 'text-orange-500' : 'text-indigo-500'}`}
                        />
                      </div>
                      <CardTitle className="text-xs sm:text-sm md:text-base lg:text-lg font-semibold">
                        {feature.title}
                      </CardTitle>
                    </div>
                  ...
                  <CardContent className="p-3 sm:p-4 md:p-6 pt-0">
                    <div
                      className={`text-[10px] sm:text-xs md:text-sm font-medium bg-gradient-to-r ${feature.color} bg-clip-text text-transparent`}
                    >
                      Accéder →
                    </div>
                  </CardContent>
        ...
        >
          <Card className="border-border/50 bg-card/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300 hover:scale-[1.02]">
            ...
            <CardContent className="p-2.5 sm:p-3 md:p-4 pt-0">
              <div className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl font-bold text-foreground">
                -
              </div>

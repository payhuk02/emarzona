...
const CourseDetail = ({ learnMode = false }: CourseDetailProps) => {
  ...
  if (isLoading) {
    return (
      <PublicPremiumChrome mainAriaLabel="Detail cours">
  ...
  return (
    <PublicPremiumChrome mainAriaLabel="Detail cours">
      <div className="min-h-screen bg-gray-50">
        {/* SEO Meta Tags */}
        <SEOMeta
          title={`${product.name} | Cours en ligne`}
          description={(product.short_description || product.description || '').slice(0, 160)}
          url={`https://www.emarzona.com/courses/${slug}`}
          image={product.image_url}
          type="product"
          price={product.promotional_price || product.price}
          currency={product.currency}
          keywords={`cours, formation, ${product.category || ''}, en ligne`}
        />
        ...
        <div className="bg-gradient-to-r from-orange-600 to-orange-800 text-white">
          <div className="container mx-auto py-12 px-4">
            <div className="max-w-4xl">
              ...
              {/* Badges: Modèle de tarification et Options de paiement */}

      ...
      <div className="container mx-auto p-3 sm:p-4 lg:p-6 space-y-4 sm:space-y-6">
        ...
        >
          <div className="flex items-center gap-2 sm:gap-3">
            <div className="p-2 rounded-lg bg-primary/10 border border-primary/20 animate-in zoom-in duration-500">
              <SettingsIcon
                className="h-5 w-5 sm:h-6 sm:w-6 lg:h-8 lg:w-8 text-primary"
                aria-hidden="true"
              />
            </div>
            <div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4 sm:space-y-6">
          <TabsList className="grid w-full grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 h-auto gap-2 overflow-x-auto">
            <TabsTrigger
              value="profile"
              className="text-xs sm:text-sm min-h-[44px] py-2 sm:py-2.5 lg:py-3"
            >
          ...
          >
            <Card className="border-border/50 bg-card/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300">
              <CardHeader className="space-y-1 px-4 py-4 sm:px-6 sm:py-5">
                <CardTitle className="text-xs sm:text-sm md:text-base lg:text-lg xl:text-xl">

...
export const LANDING_PREMIUM_SECTIONS: LandingPremiumSection[] = [
  ...
  },
  {
    ...
    elements: [
      ...
      text('hero.photoAlt', 'Alt photo hero', lp.hero.photoAlt),
      text('hero.bannerAlt', 'Alt bannière hero', lp.hero.bannerAlt),
      text('hero.bannerHeadline', 'Titre SEO bannière', lp.hero.bannerHeadline),

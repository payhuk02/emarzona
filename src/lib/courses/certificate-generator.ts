...
const COURSE_CERTIFICATE_TEMPLATE_FIELDS =
  'id,template_name,template_type,design_config,show_student_name,show_course_name,show_completion_date,show_certificate_number,show_instructor_name,show_final_score,show_duration,show_verification_code,header_text,subheader_text,body_text,footer_text,show_signature,signature_name,signature_title,signature_image_url';
...
export async function getCertificateTemplate(
  ...
  const { data: courseTemplate } = await supabase
    ...
    .select(COURSE_CERTIFICATE_TEMPLATE_FIELDS)

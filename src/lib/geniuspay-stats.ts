/**
 * Service de statistiques avancées pour GeniusPay
...
export interface GeniusPayStats {
...
/**
 * Récupère toutes les statistiques GeniusPay
 */
export async function getAllGeniusPayStats(
  startDate?: Date,
  endDate?: Date,
  storeId?: string
  ...
  return geniuspayStatsCache.getOrSet(cacheKey, async () => {
    try {
      ...
      logger.error('Error getting all GeniusPay stats:', error);
      throw error;
    }
  });
}

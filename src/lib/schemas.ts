...
export const storeSchema = z.object({
  ...
  banner_url: z.string().url('URL de la bannière invalide').optional().or(z.literal('')),

  favicon_url: z.string().url('URL du favicon invalide').optional().or(z.literal('')),

  apple_touch_icon_url: z
    .string()
    .url("URL de l'icône Apple Touch invalide")
    .optional()
    .or(z.literal('')),

  watermark_url: z.string().url('URL du filigrane invalide').optional().or(z.literal('')),

  placeholder_image_url: z
    .string()
  ...
  support_email: z.string().email("Format d'email invalide").optional().or(z.literal('')),

  sales_email: z.string().email("Format d'email invalide").optional().or(z.literal('')),

  press_email: z.string().email("Format d'email invalide").optional().or(z.literal('')),

  partnership_email: z.string().email("Format d'email invalide").optional().or(z.literal('')),
  ...
  telegram_username: z
    ...
    .regex(
      /^[a-zA-Z0-9_]+$/,
      "Le nom d'utilisateur Telegram ne peut contenir que des lettres, chiffres et underscores"
    )
    .optional()
    .or(z.literal('')),
  ...
  font_size_base: z
    .string()
    .max(20, 'La taille de police ne peut pas dépasser 20 caractères')
    .optional()
    .or(z.literal('')),
  ...
  product_grid_columns: z
    .number()
    .min(1)
    .max(6, 'Le nombre de colonnes ne peut pas dépasser 6')
    .optional()
    .nullable(),
  ...
  meta_description: z
    ...
    .max(
      160,
      'La description SEO ne doit pas dépasser 160 caractères pour un meilleur référencement'
    )
    .optional()
    .or(z.literal('')),
  ...
  og_image: z.string().url("URL de l'image Open Graph invalide").optional().or(z.literal('')),
  ...
  google_analytics_id: z
    .string()
    .regex(
      /^(G-[A-Z0-9]+|UA-\d{4,10}-\d{1,4})$/,
      "Format d'ID Google Analytics invalide (ex: G-XXXXXXXXXX ou UA-XXXXXX-XX)"
    )
    .optional()
    .or(z.literal('')),
  ...
  tiktok_pixel_id: z
    ...
    .regex(
      /^[A-Z0-9]{16,20}$/,
      "Format d'ID TikTok Pixel invalide (16-20 caractères alphanumériques)"
    )
    .optional()
    .or(z.literal('')),
...
export const storeCreateSchema = storeSchema
  .pick({
    name: true,
    slug: true,
...
export const customerSchema = z.object({
  ...
  country: z.string().max(50, 'Le pays ne peut pas dépasser 50 caractères').optional(),
...
export const authSchema = z.object({
  email: z.string().email('Email invalide').refine(isValidEmail, "Format d'email invalide"),

...
export const designSystemClasses = {
  ...
  button: {
    primary:
      'bg-primary-500 hover:bg-primary-600 text-white font-medium px-4 py-2 rounded-lg transition-colors',
    secondary:
      'bg-secondary-500 hover:bg-secondary-600 text-white font-medium px-4 py-2 rounded-lg transition-colors',
    outline:
      'border-2 border-primary-500 text-primary-500 hover:bg-primary-50 font-medium px-4 py-2 rounded-lg transition-colors',
    ghost:
      'text-primary-500 hover:bg-primary-50 font-medium px-4 py-2 rounded-lg transition-colors',
  },
  ...
  card: {
    ...
    interactive:
      'bg-card border border-border rounded-lg p-6 shadow-soft hover:shadow-medium transition-shadow cursor-pointer',
  },
  ...
  input: {
    ...
    error:
      'w-full px-4 py-2 border border-error-500 rounded-lg bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-error-500 focus:border-transparent',
  },

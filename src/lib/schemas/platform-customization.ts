...
const typographySchema = z
  .object({
    fontFamily: z
      .string()
      .max(200, 'La famille de police ne peut pas dépasser 200 caractères')
      .optional(),
...
const tokensSchema = z
  .object({
    borderRadius: z
      .string()
      .max(50, 'Le border radius ne peut pas dépasser 50 caractères')
      .optional(),
...
const withdrawalsSchema = z
  .object({
    minAmount: z
      .number()
      .int('Le montant minimum doit être un entier')
...
export const featuresSchema = z
  .object({
    enabled: z
      .array(z.string().min(1, "L'identifiant de fonctionnalité ne peut pas être vide"))
      .optional(),
    disabled: z
      .array(z.string().min(1, "L'identifiant de fonctionnalité ne peut pas être vide"))
      .optional(),
...
// Schéma pour les médias / ressources (CMS d'images)
...
export const platformCustomizationSchema = z
  .object({
    design: designSchema,

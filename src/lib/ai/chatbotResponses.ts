...
export const CHATBOT_RESPONSES = {
  // Messages d'erreur
  TECHNICAL_ERROR:
    'Désolé, je rencontre un problème technique. Un conseiller va prendre le relais.',
  RETRY_OR_CONTACT_SUPPORT:
    'Désolé, je rencontre un problème technique. Veuillez réessayer ou contacter notre support.',
  ORDER_FETCH_ERROR:
    'Je rencontre un problème pour accéder à vos commandes. Puis-je vous aider autrement ?',
  PRODUCT_SEARCH_ERROR:
    'Je rencontre un problème avec la recherche. Essayez de naviguer directement dans notre marketplace.',
  ...
  ORDER_NOT_LOGGED_IN:
    'Pour voir vos commandes, vous devez être connecté. Souhaitez-vous vous connecter ?',
  ORDER_NOT_LOGGED_IN_ACTION_LABEL: 'Se connecter',
  ORDER_NOT_FOUND:
    'Je ne trouve pas de commandes à votre nom. Avez-vous déjà passé commande sur notre plateforme ?',
  ORDER_NOT_FOUND_ACTION_LABEL: 'Découvrir nos produits',
  ORDER_LAST_STATUS: (orderId: string, status: string) =>
    `Votre dernière commande (${orderId}) est ${status}. Souhaitez-vous voir tous vos détails de commande ?`,
  ORDER_VIEW_ACTION_LABEL: 'Voir ma commande',
  ORDER_ALL_ACTION_LABEL: 'Voir toutes les commandes',

  SHIPPING_INFO:
    'Pour les informations de livraison, nous travaillons avec plusieurs transporteurs : Chronopost, Colissimo, UPS, FedEx et DHL. Les délais varient selon votre région.',
  ...
  RETURN_POLICY:
    'Notre politique de retour vous permet de retourner vos produits dans les 30 jours. Les frais de retour sont offerts pour les produits défectueux.',
  RETURN_POLICY_ACTION_LABEL: 'Voir la politique de retour',
  RETURN_INITIATE_ACTION_LABEL: 'Initier un retour',

  PRODUCT_SEARCH_NO_QUERY:
    'Que recherchez-vous exactement ? Je peux vous aider à trouver des produits digitaux, physiques, des cours ou des services.',
  PRODUCT_SEARCH_NO_QUERY_SUGGESTIONS: [
    'Un logiciel de design',
    'Des cours de programmation',
    'Des produits artisanaux',
  ],
  PRODUCT_SEARCH_NOT_FOUND: (searchTerms: string) =>
    `Je n'ai pas trouvé de produits correspondant à "${searchTerms}". Essayez avec d'autres termes ou parcourez nos catégories.`,
  PRODUCT_SEARCH_ALL_CATEGORIES_ACTION_LABEL: 'Voir toutes les catégories',
  PRODUCT_SEARCH_FOUND: (productList: string) =>
    `J'ai trouvé plusieurs produits correspondant à votre recherche : ${productList}. Voulez-vous que je vous montre plus de détails ?`,
  PRODUCT_SEARCH_VIEW_ACTION_LABEL: (productName: string) => `Voir ${productName}`,

  RECOMMENDATION_NO_PRODUCTS:
    'Découvrez nos produits phares ! Nous avons des articles digitaux, physiques, des cours et des services.',
  ...
  HELP_MESSAGE:
    'Je peux vous aider avec : vos commandes, la livraison, les retours, la recherche de produits, et des recommandations personnalisées. Que souhaitez-vous savoir ?',
  HELP_SUGGESTIONS: [
    'Où en est ma commande ?',
